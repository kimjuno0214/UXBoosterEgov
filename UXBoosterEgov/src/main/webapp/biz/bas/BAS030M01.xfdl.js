(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("gridRefe",null,"26","264","300","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("6");
            obj.set_autofittype("col");
            obj.set_binddataset("dsRefe");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"100\"/><Column size=\"80\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"적용일자\"/><Cell col=\"1\" text=\"기준치\" cssclass=\"cellImport\"/><Cell col=\"2\" text=\"부등호\" cssclass=\"cellImport\"/></Band><Band id=\"body\"><Cell text=\"bind:APLCN_YMD\" textAlign=\"center\" displaytype=\"date\" edittype=\"expr:dataset.getRowType(currow) == &apos;2&apos;?&apos;date&apos;:&apos;none&apos;\"/><Cell col=\"1\" text=\"bind:REFE\" textAlign=\"right\" edittype=\"normal\"/><Cell col=\"2\" text=\"bind:INEQ_CD\" textAlign=\"center\" displaytype=\"combotext\" combodataset=\"dsIneqCd\" combocodecol=\"CODE\" combodatacol=\"NAME\" edittype=\"combo\"/></Band></Format></Formats>");
            this.divDetail.addChild(obj.name, obj);

            obj = new Grid("gridMain","0","26",null,null,"gridRefe:10","0",null,null,null,null,this.divDetail.form);
            obj.set_taborder("1");
            obj.set_autofittype("col");
            obj.getSetter("takegrid").set("sort");
            obj.set_binddataset("dsList");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"0\"/><Column size=\"40\"/><Column size=\"170\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"80\"/><Column size=\"90\"/><Column size=\"50\"/><Column size=\"50\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"50\"/><Column size=\"50\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"시험ID\"/><Cell col=\"1\" text=\"No\"/><Cell col=\"2\" text=\"시험항목\" cssclass=\"cellImport\"/><Cell col=\"3\" text=\"시험구분\"/><Cell col=\"4\" text=\"분류1\"/><Cell col=\"5\" text=\"분류2\"/><Cell col=\"6\" text=\"분류3\"/><Cell col=\"7\" text=\"분류4\"/><Cell col=\"8\" text=\"분류5\"/><Cell col=\"9\" text=\"부속문서\"/><Cell col=\"10\" text=\"결함구분\"/><Cell col=\"11\" text=\"검출한계\"/><Cell col=\"12\" text=\"단위\"/><Cell col=\"13\" text=\"계산방법\"/><Cell col=\"14\" text=\"위해정보코드\"/><Cell col=\"15\" text=\"순번\"/><Cell col=\"16\" text=\"사용여부\" cssclass=\"cellImport\"/></Band><Band id=\"body\"><Cell text=\"bind:TEST_ID\"/><Cell col=\"1\" textAlign=\"center\" suppress=\"0\" edittype=\"none\" text=\"expr:currow + 1\"/><Cell col=\"2\" text=\"bind:TEST_ITEM_NM\" textAlign=\"left\" edittype=\"none\" combodataset=\"dsTestItemCdGrid\" combocodecol=\"CODE\" combodatacol=\"NAME\" suppress=\"0\" displaytype=\"normal\" expandimage=\"url(&apos;theme://images/btn_GridExpand_N.png&apos;)\" expandshow=\"show\" expandsize=\"21\"/><Cell col=\"3\" text=\"bind:TEST_DIV\" textAlign=\"left\" suppress=\"0\" edittype=\"normal\"/><Cell col=\"4\" text=\"bind:CL_1\" textAlign=\"left\" suppress=\"0\" edittype=\"normal\"/><Cell col=\"5\" text=\"bind:CL_2\" textAlign=\"left\" edittype=\"normal\" suppress=\"0\"/><Cell col=\"6\" text=\"bind:CL_3\" textAlign=\"left\" edittype=\"normal\" suppress=\"0\"/><Cell col=\"7\" text=\"bind:CL_4\" textAlign=\"left\" edittype=\"normal\" suppress=\"0\"/><Cell col=\"8\" textAlign=\"left\" edittype=\"normal\" text=\"bind:CL_5\" suppress=\"0\"/><Cell col=\"9\" textAlign=\"left\" edittype=\"normal\" text=\"bind:ATACH_DOC\" suppress=\"0\"/><Cell col=\"10\" text=\"bind:FAUL_DIV_CD\" textAlign=\"left\" edittype=\"combo\" combodataset=\"dsFaulDivCd\" combocodecol=\"CODE\" combodatacol=\"NAME\" suppress=\"0\"/><Cell col=\"11\" text=\"bind:DETC_LIMIT\" textAlign=\"left\" edittype=\"normal\" suppress=\"0\"/><Cell col=\"12\" text=\"bind:UNIT\" textAlign=\"left\" edittype=\"normal\" suppress=\"0\"/><Cell col=\"13\" text=\"bind:CALC_MTH_CD\" textAlign=\"left\" edittype=\"combo\" combodataset=\"dsCalcMthCd\" combocodecol=\"CODE\" combodatacol=\"NAME\" suppress=\"0\"/><Cell col=\"14\" text=\"bind:HARM_INFO_CD\" textAlign=\"center\" edittype=\"none\" suppress=\"0\" displaytype=\"normal\" expandshow=\"show\" expandimage=\"url(&apos;theme://images/btn_GridExpand_N.png&apos;)\" tooltiptext=\"bind:HARM_INFO_NM\" expandsize=\"21\"/><Cell col=\"15\" text=\"bind:SN\" textAlign=\"center\" edittype=\"normal\" suppress=\"0\" editinputtype=\"dot,digit\"/><Cell col=\"16\" text=\"bind:USE_YN\" textAlign=\"center\" edittype=\"combo\" suppress=\"0\" editinputtype=\"dot,digit\" displaytype=\"combotext\" combodataset=\"dsUseYnGrid\" combocodecol=\"CODE\" combodatacol=\"NAME\"/></Band></Format></Formats>");
            this.divDetail.addChild(obj.name, obj);
            ...
            obj = new Static("staProgListTitle00_01_00",null,"gridRefe:10","150","21","110",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("8");
            obj.set_text("수수료");
            obj.set_cssclass("sta_WF_title02");
            this.divDetail.addChild(obj.name, obj);

            obj = new Grid("gridFee",null,"staProgListTitle00_01_00:5","264",null,"0","0",null,null,null,null,this.divDetail.form);
            obj.set_taborder("9");
            obj.set_autofittype("col");
            obj.set_binddataset("dsFee");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"200\"/><Column size=\"100\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"시험항목\"/><Cell col=\"1\" text=\"수수료\"/></Band><Band id=\"body\"><Cell text=\"bind:TEST_ITEM_CD\" textAlign=\"left\" edittype=\"none\" displaytype=\"combotext\" combodataset=\"dsTestItemCd\" combocodecol=\"CODE\" combodatacol=\"NAME\"/><Cell col=\"1\" text=\"bind:FEE\" textAlign=\"right\" displaytype=\"normal\" edittype=\"normal\" editinputtype=\"number\"/></Band></Format></Formats>");
            this.divDetail.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("BAS030M01.xfdl", function() {
        /**
        *  공통시험항목관리 화면
        *
        ...
        ********************************************************/
        ...
        this.fnSearch = function(sTranId)
        {
        	...
        	/* 수수료 조회 */
        	this.dsFee.clearData();
        	take.tranSelect(this, "SearchFee", "basicInfo.testComFeeSelect", "dsSearch", "dsFee", "", "fnCallback");
        };

        /**
         * fnSave : 저장 transaction (필수) -->공통 저장에서 호출할 디폴트값 세팅 필요
         * @param  {String} sTranI 트랜젝션 아이디
         * @return {N/A}    N/A
        ...
        this.fnSave = function(sTranId)
        {
        	...
        	//데이터셋 수정 여부 확인
        	if (!take.isDsModified(this.dsList) && !take.isDsModified(this.dsRefe) && !take.isDsModified(this.dsFee))
            {
        	...
        	if(bRtn)
        	{
        		...
        		this.dsFee.set_updatecontrol(false);
        		for(var i = 0; i < this.dsFee.rowcount; i++)
        		{
        			if(take.isEmpty(this.dsFee.getColumn(i, "FEE_ID"))) this.dsFee.setRowType(i, "I");
        		}
        		this.dsFee.set_updatecontrol(true);
        		...
        		var sParam = "sNameSpace=basicInfo.testItemInsert|basicInfo.testItemUpdate|basicInfo.testItemDelete,"
        							  ...
        							  + "basicInfo.testInstFeeInsert|basicInfo.testInstFeeUpdate|basicInfo.testInstFeeDelete"
        							  + " sDataset=dsList|dsRefe|dsFee";

        		take.transaction(this, sTranId, "SVC_LOC::doore/saveList.do", "dsList=dsList:U dsRefe=dsRefe:U dsFee=dsFee:U ", "", sParam, "fnCallback", false);
        	}
        };
        ...
        */
         ...
         this.divDetail_btnAddRefe_onclick = function(obj,e)
        {
            ...
            {
                take.alert(this, "Info", "품목 정보를 저장후 작업하여 주십시오.");
                return false;
            }
        ...
        */
        ...
        this.loadIncludeScript("BAS030M01.xfdl");
