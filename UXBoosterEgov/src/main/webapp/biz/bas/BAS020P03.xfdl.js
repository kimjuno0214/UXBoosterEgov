(function()
{
    return function()
    {
        ...
        {
            this.set_name("BAS020P03");
            this.set_background("#ffffff");
            this.set_titletext("위해정보코드 등록");
            if (Form == this.constructor)
            {
                this._setFormPosition(1110,680);
            }
            ...
            obj = new Combo("cboUseYn","438","10","201","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            ...
            obj = new Layout("default","",0,0,this.divSearch.form,
                ...
                p.cboUseYn.move("438","10","201","21",null,null);
            	}
            );
            ...
            this.divDetail.form.addLayout(obj.name, obj);
            //-- Default Layout : this
            obj = new Layout("default","",1110,680,this,function(p){});
        ...
        // User Script
        this.registerScript("BAS020P03.xfdl", function() {
        /**
        *  위해정보코드등록
        *
        ...
        */
        this.Form_onload = function(obj, e)
        {
           ...
           {
                // 공통코드 조회
        		take.tranCode(this, ["CERT_FLD_CD", "YN", "YN"]
        		                  , ["dsCertFldCd", "dsUseYn", "dsUseYnAll"]
        						  , ["","","ALL"],
        ...
        ********************************************************/
        ...
        {
        	gFnExcelDown (this, this.divDetail.form.grdList, "위해정보코드_" + this.divSearch.form.cboCertFldCd.value);
        };
        ...
        */
        this.fnExcelImport_onsuccess = function(obj,  e)
        {
            ...
            this.dsList.clearData();
        	var strMapp = "REF1=Column0,CODE_ID=Column1,CODE_NM=Column2,REF2=Column3,CODE_ORDER=Column4,USE_YN=Column5,CODE_KEY=Column6";
        	...
        	for(var i = 0; i < nCnt; i++) {
        		...
        		this.dsList.setColumn(nRow, "PARENT_KEY", "0004400052");
        		// 인증분야 코드 처리
        		var sCertFldCd = this.dsList.getColumn(nRow, "REF1");
        ...
        */
        ...
        this.loadIncludeScript("BAS020P03.xfdl");
