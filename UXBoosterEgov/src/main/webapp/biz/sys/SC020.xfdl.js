(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divDetail","10","btnShowHide:10",null,null,"10","10","1300",null,null,null,this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);

            obj = new Static("staMlGroupTitle","0","10","280","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("0");
            obj.set_text("다국어그룹");
            obj.set_cssclass("sta_WF_title02");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staMlInfoTitle","300","10",null,"21","170",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("1");
            obj.set_text("다국어목록");
            obj.set_cssclass("sta_WF_title02");
            this.divDetail.addChild(obj.name, obj);

            obj = new Grid("grdMultilanguageGroup","0","36","280",null,null,"0",null,null,null,null,this.divDetail.form);
            obj.set_taborder("2");
            ...
            obj = new Grid("grdMultilanguageInfo","300","36",null,"407","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("3");
            obj.set_autofittype("col");
            ...
            obj = new Static("Static06","280","443",null,"20","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("8");
            obj.set_text("20");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
            ...
            obj = new Static("staMultilanguageDetailTitle","300","463",null,"21","170",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("4");
            obj.set_text("다국어정보");
            obj.set_cssclass("sta_WF_title02");
            this.divDetail.addChild(obj.name, obj);

            obj = new Button("btnSaveSub","1539","463",null,"21","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("5");
            obj.set_text("다국어저장");
            this.divDetail.addChild(obj.name, obj);
            ...
            obj = new Static("Static27","280","10","20",null,null,"-4",null,null,null,null,this.divDetail.form);
            obj.set_taborder("7");
            obj.set_text("20");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
            ...
            obj = new Static("Static00","1649","0",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("10");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
        ...
        this.fnTran = function(sTranId)
        {
            ...
            switch(sTranId)
            {
                case "Group" :
        			...
        			take.tranSelect(this, "Group", "SystemCommon.multilanguageInfoGroup", "", "dsMultilanguageGroup", "sMlGroup='"+sMlGroup +"'", sCallBack);
