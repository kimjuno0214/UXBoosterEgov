(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"USER_CD\" type=\"STRING\" size=\"255\"/><Column id=\"USER_ID\" type=\"STRING\" size=\"255\"/><Column id=\"USER_NM\" type=\"STRING\" size=\"255\"/><Column id=\"PROJECT_CD\" type=\"STRING\" size=\"256\"/><Column id=\"USER_EMAIL\" type=\"STRING\" size=\"256\"/><Column id=\"USER_MOBILE\" type=\"STRING\" size=\"256\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static07","355","0","285","10",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("285");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
            ...
            obj = new Static("Static08","355","31","285","11",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("285");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
            ...
            obj = new Static("Static09","0","52",null,"20","0",null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Div("divDetail","10","Static09:0",null,null,"10","10","1300",null,null,null,this);
            obj.set_taborder("3");
            this.addChild(obj.name, obj);

            obj = new Static("Static27","554","0","20",null,null,"0",null,null,null,null,this.divDetail.form);
            obj.set_taborder("3");
            obj.set_text("20");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
            ...
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"20\"/><Column size=\"120\"/><Column size=\"288\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"권한코드\" autosizecol=\"limitmin\"/><Cell col=\"2\" text=\"권한명\" autosizecol=\"limitmin\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\" autosizerow=\"limitmin\"/><Cell col=\"1\" text=\"bind:ROLE_CD\" cssclass=\"cellC\" autosizerow=\"limitmin\"/><Cell col=\"2\" text=\"bind:ROLE_NM\" autosizerow=\"limitmin\"/></Band></Format></Formats>");
            this.divDetail.addChild(obj.name, obj);

            obj = new Button("btnRoleSave",null,"0","58","21","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("10");
            obj.set_text("권한저장");
            this.divDetail.addChild(obj.name, obj);

            obj = new Button("btnRoleCopy",null,"0","86","21","btnRoleSave:3",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("5");
            obj.set_text("권한가져오기");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("Static09",null,"grdUserRoleList:0","1065","24","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("11");
            obj.set_text("Static03");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
            ...
            obj = new Static("staUserListT00_00","Static27:0","Static09:0","450","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("6");
            obj.set_text("화면 권한");
            obj.set_cssclass("sta_WF_title02");
            this.divDetail.addChild(obj.name, obj);

            obj = new Grid("grdRoleMenu","Static27:0","staUserListT00_00:5",null,null,"0","0",null,null,null,null,this.divDetail.form);
            obj.set_taborder("7");
            obj.set_autofittype("col");
            ...
            obj = new Button("btnDelRow",null,"427","46","21","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("9");
            obj.set_text("삭제");
            obj.set_cssclass("btn_WF_cancel02");
            this.divDetail.addChild(obj.name, obj);

            obj = new Button("btnAddRow",null,"427","46","21","btnDelRow:3",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("8");
            obj.set_text("추가");
        ...
        */
        ...
        this.divSearch_Static07_00_00_00_onclick = function(obj,e)
        {
