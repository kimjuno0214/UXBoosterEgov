(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"PROJECT_CD\" type=\"STRING\" size=\"255\"/><Column id=\"PROJECT_NM\" type=\"STRING\" size=\"255\"/><Column id=\"ML_CD\" type=\"STRING\" size=\"255\"/><Column id=\"PROJECT_TYPE\" type=\"STRING\" size=\"255\"/><Column id=\"MANAGER_CD\" type=\"STRING\" size=\"255\"/><Column id=\"MANAGER_NM\" type=\"STRING\" size=\"255\"/><Column id=\"PROJECT_IMG\" type=\"STRING\" size=\"255\"/><Column id=\"DESC_TXT\" type=\"STRING\" size=\"255\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"255\"/><Column id=\"REG_DT\" type=\"STRING\" size=\"255\"/><Column id=\"REG_CD\" type=\"STRING\" size=\"255\"/><Column id=\"REG_NM\" type=\"STRING\" size=\"255\"/><Column id=\"MOD_DT\" type=\"STRING\" size=\"255\"/><Column id=\"MOD_CD\" type=\"STRING\" size=\"255\"/><Column id=\"MOD_NM\" type=\"STRING\" size=\"255\"/><Column id=\"FILE_BLOB\" type=\"STRING\" size=\"256\"/><Column id=\"PROJECT_BLOB\" type=\"STRING\" size=\"255\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staTypeT","20","10","80","21",null,null,"80",null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("유형");
            obj.set_cssclass("sta_WF_textR");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staProjectNmT","355","10","80","21",null,null,"80",null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("프로젝트명");
            obj.set_cssclass("sta_WF_textR");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("staUseYnT","690","10","80","21",null,null,"80",null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("사용여부");
            obj.set_cssclass("sta_WF_textR");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboUseYn","staUseYnT:0","10","205","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            ...
            obj = new Static("Static07_00_00_00_01","690","0","285","10",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("13");
            obj.set_text("285");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
            ...
            obj = new Static("Static23_test","0","0","10",null,null,"0",null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new Static("staProjectNm","789","56",null,"31","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("7");
            obj.set_cssclass("sta_WF_td01L");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staUseYn","789","116",null,"31","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("8");
            obj.set_cssclass("sta_WF_td01L");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staType","789","86",null,"31","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("9");
            obj.set_cssclass("sta_WF_td01L");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staDirector","789","146",null,"31","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("10");
            obj.set_cssclass("sta_WF_td01L");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staDetailDescT","686","176","120","93",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("11");
            obj.set_text("상세설명");
            obj.set_cssclass("sta_WF_th01L");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staDetailDesc","805","176",null,"93","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_td01L");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staProjectIdT","686","26","120","31",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("13");
            ...
            obj = new Combo("cboUseYn","813","121","200","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("3");
            obj.set_innerdataset("dsCboUseYn");
            obj.set_codecolumn("CODE");
            obj.set_datacolumn("NAME");
            ...
            obj = new Combo("cboType","813","91","200","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("2");
            obj.set_innerdataset("dsCboType");
            obj.set_codecolumn("CODE");
            obj.set_datacolumn("NAME");
            ...
            obj = new Edit("edtDirector","813","151","176","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("4");
            obj.set_readonly("true");
            obj.set_cssclass("edt_WF_essential");
            this.divDetail.addChild(obj.name, obj);

            obj = new Edit("edtProjectNm","813","61","200","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("1");
            ...
            obj = new TextArea("txtDetailDesc","813","183",null,"79","7",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("6");
            obj.set_maxlength("600");
            this.divDetail.addChild(obj.name, obj);

            obj = new Button("btnDirector","edtDirector:3","151","21","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("5");
            obj.set_cssclass("btn_WF_search02");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staProjectNmT","686","56","120","31",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("15");
            obj.set_text("프로젝트 명");
            obj.set_cssclass("sta_WF_th01L");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staUseYnT","686","116","120","31",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("16");
            obj.set_text("사용여부");
            obj.set_cssclass("sta_WF_th01L");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staDirectorT","686","146","120","31",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("17");
            obj.set_text("담당자");
            obj.set_cssclass("sta_WF_th01L");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staImgPm","330","26","357","303",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("18");
            obj.set_cssclass("sta_WF_td01L");
            this.divDetail.addChild(obj.name, obj);
            ...
            obj = new Static("staReg","805","268","214","31",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("23");
            obj.set_cssclass("sta_WF_td01L");
            this.divDetail.addChild(obj.name, obj);
            ...
            obj = new Static("staMod","805","298","214","31",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("27");
            obj.set_cssclass("sta_WF_td01L");
            obj.set_text("");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("Static22","331","329",null,"20","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("29");
            obj.set_text("20");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
            ...
            obj = new Static("staProjectDetailT","330","0",null,"21","152",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("30");
            ...
            obj = new Static("Static45","310","26","20",null,null,"0",null,null,null,null,this.divDetail.form);
            obj.set_taborder("34");
            ...
            obj = new Static("Static22","0","823",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("20");
            ...
            obj = new Static("Static23_test00",null,"0","10",null,"0","0",null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("Static23");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
            ...
            obj = new BindItem("item11","divDetail.form.imgPm","image","dsProjectInfoDetail","FILE_BLOB");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        ********************************************************/
        ...
        this.fnSave = function(sTranId)
        {
        	...
        	if(sTranId == "ProjectInfoDelete")
        	{
        		...
        		(
        			this,
        			"ProjectInfoDelete",
        			"SVC_LOC::pm/projectInfoDelete.do",
        			"dsProjectInfoDetail=dsProjectInfoDetail:U",
        			"",
        			"PROJECT_CD='" + sProjectCd + "'",
        			"fnCallback"
        		);
        		//take.tranSave(this, "ProjectInfoDelete", "ProjectManagement.projectInfo", "dsProjectInfoDetail","", "PROJECT_CD='" + sProjectCd + "'", "fnCallback")
        	}
        };
            ...
            switch(sGrdId) {
        		case "grdProjectInfo":
        			...
        			if(take.nvl(objDivDetail.staProjectId, "") != ""){
        				objDivDetail.staProjectId.set_text("자동생성");
        			}
        ...
        this.grdProjectInfo_onselectchanged = function(obj,e)
        {
        	...
        	if( nCurrSelRow != -1 && (nPreSelRow != nCurrSelRow))
        	{
        		...
        		{
        			bRowChange = take.confirm(this, "Info", "작업중인 데이터는 저장되지 않습니다.\n그래도 이동하시겠습니까?");
        		}
        ...
        this.fnDetailSearch = function ()
        {
        	...
        	(
        		...
        		function(sId, nErrCd, sErrMsg){
        			...
        			if(take.isEmpty(this.dsProjectInfoDetail.getColumn(0, "FILE_BLOB"))){
        				this.divDetail.form.imgPm.set_text("+");
        			}else{
        				this.divDetail.form.imgPm.set_text("");
        			}
        			...
        			(
        				...
        				function(sId, nErrCd, sErrMsg)
        				{
        					...
        					if (objDsCboProj.rowcount>0)
        					{
        						...
        						objDsCboProj.setColumn(addInsertRow, "PROJECT_NM", "전체");
        					}
        				}
        			)
                    break;
