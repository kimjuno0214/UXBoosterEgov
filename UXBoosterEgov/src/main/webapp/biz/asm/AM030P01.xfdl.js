(function()
{
    return function()
    {
        ...
        {
            this.set_name("AM030P01");
            this.set_titletext("Query조회");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"255\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"Query 명\"/></Band><Band id=\"body\"><Cell text=\"bind:QUERY_NM\" textAlign=\"left\"/></Band></Format></Formats>");
            this.divDetail.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("AM030P01.xfdl", function() {
        /**
        *  Query 조회
        *
        ...
        */
        ...
        {
        	this.ProgId="AM030P01";
            this.ProgNm="Query 조회";
        ...
        ********************************************************/
        ...
        this.fnSearch = function(sTranId)
        {
            ...
            this.dsQueryList.clearData();

        	var sParam;
        	sParam = "sName='" + take.nvl(this.divSearch.form.edtName.value, "") + "'";

        	take.transaction(
        				this,
        				"QueryList",
        				"SVC_LOC::asm/AM030P01List.do",
        				"",
        ...
        */
        this.fnCallback = function(sId, nErrCd, sErrMsg)
        {
            ...
            {
        		case "initSearch" :
        			if(this.dsQueryList.getRowCount() == 1){
        				//this.fnSendData();
        			}
                    break;
                case "select" :
        ...
        this.loadIncludeScript("AM030P01.xfdl");
