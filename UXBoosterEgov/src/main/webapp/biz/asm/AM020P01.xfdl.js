(function()
{
    return function()
    {
        ...
        {
            this.set_name("AM020P01");
            this.set_titletext("Mapper 생성");
            this.set_background("#ffffff");
            if (Form == this.constructor)
            {
                this._setFormPosition(478,90);
            }
            ...
            obj = new Static("Static05","20","43","100","31",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Mapper명");
            obj.set_cssclass("sta_WF_th01L");
            this.addChild(obj.name, obj);

            obj = new Static("Static06","118","43","340","31",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_cssclass("sta_WF_td01L");
            this.addChild(obj.name, obj);

            obj = new Edit("edtTitle","125","48","326","21",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_maxlength("25");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",478,90,this,function(p){});
        ...
        // User Script
        this.registerScript("AM020P01.xfdl", function() {
        /**
        *  SYSTEM FORM NAME
        *
        ...
        */
        this.AM020P01_onload = function(obj,e)
        {
        ...
        */
        ...
        {
            this.addEventHandler("onload",this.AM020P01_onload,this);
            this.btnSave.addEventHandler("onclick",this.btnSave_onclick,this);
        };
        this.loadIncludeScript("AM020P01.xfdl");
