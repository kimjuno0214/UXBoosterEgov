(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("gridTestInst","0","staProgDetailT00_00:5","200",null,null,"0",null,null,null,null,this);
            obj.set_taborder("1");
            obj.getSetter("takegrid").set("no");
            obj.set_autofittype("col");
            obj.set_binddataset("dsInstCd");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"시험기관\"/></Band><Band id=\"body\"><Cell text=\"bind:TEST_INST_CD\" textAlign=\"left\" displaytype=\"combotext\" combodataset=\"dsTestInstCd\" combocodecol=\"CODE\" combodatacol=\"NAME\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("staProgDetailT00_00_00","gridTestInst:10","10","125","21",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("계획검토");
            obj.set_cssclass("sta_WF_title02");
            this.addChild(obj.name, obj);

            obj = new Grid("grdPlanGds","gridTestInst:10","36",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_autofittype("col");
            obj.set_binddataset("dsOdrGds");
            obj.set_readonly("false");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"200\"/><Column size=\"200\"/><Column size=\"94\"/><Column size=\"94\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"300\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"24\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"인증종류\"/><Cell col=\"1\" rowspan=\"2\" text=\"품목명\"/><Cell col=\"2\" rowspan=\"2\" text=\"세부품목명\" autosizecol=\"limitmin\"/><Cell col=\"3\" rowspan=\"2\" text=\"가능여부\" autosizecol=\"limitmin\"/><Cell col=\"4\" rowspan=\"2\" text=\"최대가능수량\" autosizecol=\"limitmin\"/><Cell col=\"5\" colspan=\"2\" text=\"시험 불가 기간\" autosizecol=\"limitmin\"/><Cell col=\"7\" rowspan=\"2\" text=\"비고\" autosizecol=\"limitmin\"/><Cell row=\"1\" col=\"5\" text=\"시작일\"/><Cell row=\"1\" col=\"6\" text=\"종료일\"/></Band><Band id=\"body\"><Cell text=\"bind:CERT_KND_NM\" suppress=\"1\"/><Cell col=\"1\" text=\"bind:GDS_NM\" suppress=\"1\"/><Cell col=\"2\" text=\"bind:DETAIL_GDS_NM\" edittype=\"none\" autosizecol=\"limitmin\" textAlign=\"left\"/><Cell col=\"3\" text=\"bind:POSBL_YN_CD\" edittype=\"none\" autosizecol=\"limitmin\" textAlign=\"center\" combodataset=\"dsYn\" combocodecol=\"CODE\" combodatacol=\"NAME\" combodisplaynulltext=\"Y\" combodisplaynulltype=\"nulltext\"/><Cell col=\"4\" text=\"bind:POSBL_QY\" edittype=\"none\" autosizecol=\"limitmin\" textAlign=\"center\"/><Cell col=\"5\" text=\"bind:IMPRTY_BGNDE\" edittype=\"none\" autosizecol=\"limitmin\" textAlign=\"center\" displaytype=\"normal\"/><Cell col=\"6\" text=\"bind:IMPRTY_ENDDE\" edittype=\"none\" autosizecol=\"limitmin\" textAlign=\"center\" displaytype=\"normal\"/><Cell col=\"7\" text=\"bind:RM\" edittype=\"none\" autosizecol=\"limitmin\" textAlign=\"left\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.registerScript("PLN010S03.xfdl", function() {
        /**
        *  안전성조사 계획관리 기관검토
        *
        ...
        */
        this.Form_onload = function(obj,e)
        {
           ...
           {
        		// 공통코드 조회
        		take.tranCode(this,["YN","CERT_KND_CD","TEST_INST_CD"], ["dsYn","dsCertKndCd","dsTestInstCd"],["","",""],
        ...
        ********************************************************/
        ...
        {
        	if(take.isEmpty(this.dsInstCd.getColumn(this.dsInstCd.rowposition, "TEST_INST_CD"))) return false;

        	var sTestInstCd = this.dsInstCd.getColumn(this.dsInstCd.rowposition, "TEST_INST_CD");

        	this.dsSearch.setColumn(0, "TEST_INST_CD", sTestInstCd);
        	this.dsOdrGds.clearData();
        ...
        this.loadIncludeScript("PLN010S03.xfdl");
