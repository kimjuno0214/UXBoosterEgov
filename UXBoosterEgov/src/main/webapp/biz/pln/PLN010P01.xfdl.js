(function()
{
    return function()
    {
        ...
        {
            this.set_name("PLN010P01");
            this.set_titletext("일정코드 등록");
            this.set_background("#ffffff");
            if (Form == this.constructor)
            {
                this._setFormPosition(770,680);
            }
            ...
            obj = new Combo("cboUseYn","410","10","201","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            ...
            obj = new Static("Static07_00_01_00","cboUseYn:0","0","50",null,null,"0",null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            obj.set_text("50");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"0\"/><Column size=\"250\"/><Column size=\"50\"/><Column size=\"50\"/><Column size=\"0\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"DOC_KEY\"/><Cell col=\"1\" text=\"일정명\" cssclass=\"cellImport\"/><Cell col=\"2\" text=\"정렬순번\" cssclass=\"cellImport\"/><Cell col=\"3\" text=\"사용여부\" cssclass=\"cellImport\"/><Cell col=\"4\"/></Band><Band id=\"body\"><Cell text=\"bind:CODE_KEY\" textAlign=\"left\" edittype=\"none\"/><Cell col=\"1\" text=\"bind:CODE_NM\" textAlign=\"left\" edittype=\"normal\"/><Cell col=\"2\" text=\"bind:CODE_ORDER\" textAlign=\"right\" edittype=\"normal\" editinputtype=\"number\"/><Cell col=\"3\" text=\"bind:USE_YN\" textAlign=\"center\" wordWrap=\"char\" displaytype=\"combotext\" edittype=\"combo\" combodataset=\"dsUseYn\" combocodecol=\"CODE\" combodatacol=\"NAME\"/><Cell col=\"4\"/></Band></Format></Formats>");
            this.divDetail.addChild(obj.name, obj);
            ...
            obj = new Layout("default","",0,0,this.divSearch.form,
                ...
                p.cboUseYn.move("410","10","201","21",null,null);
                ...
                p.Static07_00_01_00.move("cboUseYn:0","0","50",null,null,"0");
            ...
            this.divDetail.form.addLayout(obj.name, obj);
            //-- Default Layout : this
            obj = new Layout("default","",770,680,this,function(p){});
        ...
        // User Script
        this.registerScript("PLN010P01.xfdl", function() {
        /**
        *  일정코드등록
        *
        *  @MenuPath    안전성조사 > 계획관리 > 안전성조사계획 > 일정코드등록팝업
        ...
        ********************************************************/
        ...
        this.fnSearch = function(sTranId)
        {
        	...
        	this.dsSearch.setColumn(0, "GROUP_ID", "SCHDUL_CD");
        ...
        {
        	gFnExcelDown (this, this.divDetail.form.grdList, "일정코드");
        };
        ...
        */
        this.fnCallback = function(sId, nErrCd, sErrMsg)
        {
        	...
        	switch(sId)
            {
                ...
                case "Search" :  //조회 콜백
        			this.dsList.filter("");
        			this.dsList.filter("CODE_NM != '직접입력'" );
                    break;
                default :
                    break;
            }
        ...
        this.loadIncludeScript("PLN010P01.xfdl");
