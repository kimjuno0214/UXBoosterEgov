(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("Button03","535","0","10",null,null,"0",null,null,null,null,this.divDetail.form);
            obj.set_taborder("13");
            obj.set_cssclass("btn_WF_splitter");
            obj.set_text("");
            this.divDetail.addChild(obj.name, obj);

            obj = new Div("Div02","0","27",null,null,"Button03:5","0",null,null,null,null,this.divDetail.form);
            obj.set_taborder("3");
            obj.set_cssclass("dvi_WF_tabBox01");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("Static04",null,"0","100","5","0",null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("0");
            obj.set_text("5");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
            ...
            obj = new Static("Static00","0","5","120","31",null,null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("1");
            obj.set_text("Label");
            obj.set_cssclass("sta_WF_th01L");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Static("Static01","0","35","120","31",null,null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("2");
            obj.set_text("Label");
            obj.set_cssclass("sta_WF_th01L");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Static("Static05","0","65","120","31",null,null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("3");
            obj.set_text("Label");
            obj.set_cssclass("sta_WF_th01L");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Static("Static06","0","95","120","31",null,null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("4");
            obj.set_text("Label");
            obj.set_cssclass("sta_WF_th01L");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Static("Static07","0","125","120","31",null,null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("5");
            obj.set_text("Label");
            obj.set_cssclass("sta_WF_th01L");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Static("Static08","0","155","120","31",null,null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("6");
            obj.set_text("Label");
            obj.set_cssclass("sta_WF_th01L");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Static("Static09","0","185","120","31",null,null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("7");
            obj.set_text("Label");
            obj.set_cssclass("sta_WF_th01L");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Static("Static10","118","5",null,"31","0",null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("8");
            obj.set_cssclass("sta_WF_td01L");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Static("Static11","118","35",null,"31","0",null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("9");
            obj.set_cssclass("sta_WF_td01L");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Static("Static12","118","95",null,"31","0",null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("10");
            obj.set_cssclass("sta_WF_td01L");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Static("Static13","118","65",null,"31","0",null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("11");
            obj.set_cssclass("sta_WF_td01L");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Static("Static14","118","155",null,"31","0",null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_td01L");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Static("Static15","118","125",null,"31","0",null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("13");
            obj.set_cssclass("sta_WF_td01L");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Static("Static17","118","185",null,"31","0",null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("14");
            obj.set_cssclass("sta_WF_td01L");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Edit("Edit00","127","10","393","21",null,null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("15");
            obj.set_cssclass("edt_WF_essential");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Edit("Edit01","127","40","393","21",null,null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("16");
            obj.set_cssclass("edt_WF_essential");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Combo("Combo00","127","70","393","21",null,null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("17");
            obj.set_cssclass("cmb_WF_essential");
            obj.set_text("Combo00");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Combo("Combo01","127","100","393","21",null,null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("18");
            obj.set_cssclass("cmb_WF_essential");
            obj.set_text("Combo00");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Edit("Edit02","127","130","369","21",null,null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("19");
            obj.set_cssclass("edt_WF_essential");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Edit("Edit03","127","160","393","21",null,null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("20");
            obj.set_cssclass("edt_WF_essential");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Combo("Combo04","127","190","393","21",null,null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("21");
            obj.set_cssclass("cmb_WF_essential");
            obj.set_text("Combo00");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Button("Button00","Edit02:3","130","21","21",null,null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("22");
            obj.set_cssclass("btn_WF_search02");
            this.divDetail.form.Div02.addChild(obj.name, obj);

            obj = new Static("Static04_00",null,"717","100","3","0",null,null,null,null,null,this.divDetail.form.Div02.form);
            obj.set_taborder("23");
            obj.set_text("3");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
            ...
            obj = new Grid("Grid00","Button03:5","0",null,null,"0","0",null,null,null,null,this.divDetail.form);
            obj.set_taborder("0");
            ...
            obj = new Button("Button00","0","0","90","27",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("1");
            obj.set_text("tab01");
            obj.set_cssclass("btn_WF_tab02");
            this.divDetail.addChild(obj.name, obj);

            obj = new Button("Button01","90","0","90","27",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("2");
            obj.set_text("tab02");
            obj.set_cssclass("btn_WF_tab01");
            this.divDetail.addChild(obj.name, obj);

            obj = new Button("Button05","473","0","27","27",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("4");
            obj.set_cssclass("btn_WF_tabPrev");
            this.divDetail.addChild(obj.name, obj);

            obj = new Button("Button04","502","0","27","27",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("5");
            obj.set_cssclass("btn_WF_tabNext");
            this.divDetail.addChild(obj.name, obj);

            obj = new Button("Button06","180","0","90","27",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("6");
            obj.set_text("tab03");
            obj.set_cssclass("btn_WF_tab01");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("Static23_01","521","83","27","30",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("7");
            obj.set_text("5");
            obj.set_color("red");
            ...
            obj = new Static("Static21_01","530","86","5","40",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("8");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
            obj.set_color("red");
            ...
            obj = new Static("Static21_01_00","545","86","5","40",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("9");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
            obj.set_color("red");
            ...
            obj = new Static("Static23_01_01","421","15","27","30",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("11");
            obj.set_text("5");
            obj.set_color("red");
            obj.set_font("normal 11px/normal \"Arial\"");
            ...
            obj = new Static("Static23_01_00","536","83","27","30",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("10");
            obj.set_text("5");
            obj.set_color("red");
            obj.set_font("normal 11px/normal \"Arial\"");
        ...
        this.loadIncludeScript("Guide008.xfdl");
