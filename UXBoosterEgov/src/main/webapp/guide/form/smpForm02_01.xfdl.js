(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("Sample02_01 - CRUD");
            ...
            obj._setContents("<ColumnInfo><Column id=\"USER_ID\" type=\"STRING\" size=\"256\"/><Column id=\"USE_YN\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsCboUseYn2", this);
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"NAME\">- 전체 -</Col></Row><Row><Col id=\"CODE\">Y</Col><Col id=\"NAME\">사용</Col></Row><Row><Col id=\"NAME\">미사용</Col><Col id=\"CODE\">N</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("grdDetail","grdList:20","staTitleR:5",null,null,"0","0",null,null,null,null,this.divDetail.form);
            obj.set_taborder("1");
            ...
            obj = new BindItem("item4","divSearch.form.edtDept","value","dsSearch","USER_ID");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("smpForm02_01.xfdl", function() {
        /**
        *  SYSTEM FORM NAME
        *
        ...
        ********************************************************/
        ...
        this.fnSearch = function(sTranId)
        {
        	...
        	switch(sTranId) {
                ...
                case "userSelect":
                    ...
                    sDeptCd = objDept.getColumn(objDept.rowposition, "DEPT_CD");
        ...
        this.fnSave = function(sTranId)
        {
        	...
        	if (bRtn)
        	{
        		//take.tranSave(this, sTranId, "Sample.smpForm02", "dsList", "", "", "fnCallBack");
                take.transaction(this, sTranId, "SVC_LOC::sample/smpForm02Save.do", "dsList=dsList:U", "", "", "fnCallBack");
        	}
        }
        ...
        this.fnAddRow = function(sGrdId, nRow)
        {
        	...
        	var sDeptCd = objDsDept.getColumn(objDsDept.rowposition, "DEPT_CD");

        	objDs.setColumn(nAddRow, "DEPT_CD", sDeptCd);
        ...
        this.fnDelRow = function(sGrdId, arrnRow)
        {
        	...
        	nRow      = objDsList.rowposition;
        	arrChk 	  = take.getChkRow(objDsList);

        	if(arrChk.length > 0) {
        		if (take.confirm(this, "Info", "삭제 하시겠습니까?."))
                {
                    objDsList.deleteMultiRows(arrChk);
                }
        	} else {
        ...
        ********************************************************/
        ...
        {
            var sOutDs      = ["dsCboStatus", "dsCboUseYn",	"dsCboUseYn2"];
            var sGroupCodes = ["00017"		, "00009"	  ,	"00009"		 ];
            var sHeaderType = ["ALL"		, "SEL"		  ,	""			 ];
        ...
        */
        this.fnCallBack = function(sId, nErrCd, sErrMsg)
        {
            ...
            switch(sId)
            {
                case "deptSelect" :  //조회 콜백
                    this.divDetail.form.staTitleL.set_text("부서목록 (총 " + this.dsDept.rowcount + "건)");
        			this.fnSearch("userSelect");
                    break;

                case "userSelect" : //조회 콜백
                    this.divDetail.form.staTitleR.set_text("사용자 목록 (총 " + this.dsList.rowcount + "건)");
                    break;
        ...
        this.loadIncludeScript("smpForm02_01.xfdl");
