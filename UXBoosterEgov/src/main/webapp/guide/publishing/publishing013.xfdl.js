(function()
{
    return function()
    {
        ...
        {
            this.set_name("publishing013");
            this.set_titletext("프로그램컴포넌트관리");
            ...
            obj = new Edit("Edit11","Static05:3","10","110","21",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("2");
            this.Div01.addChild(obj.name, obj);

            obj = new Combo("Combo00","Static00:3","10","110","21",null,null,null,null,null,null,this.Div01.form);
            obj.set_taborder("3");
            ...
            obj = new Static("Static20","300","67",null,"30","180",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Test");
            obj.set_cssclass("sta_WF_title02");
            this.addChild(obj.name, obj);

            obj = new Static("Static45","290","89","10","200",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new Grid("Grid01","300","97",null,"303","10",null,null,null,null,null,this);
            obj.set_taborder("10");
            ...
            obj = new Static("Static00","300","410",null,"30","180",null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("Test");
            obj.set_cssclass("sta_WF_title02");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("Grid02","300","442",null,null,"10","10",null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_autofittype("col");
            obj.set_binddataset("Dataset00");
            ...
            obj = new Grid("Grid00","10","97","280",null,null,"10",null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_binddataset("Dataset00");
            obj.set_autofittype("col");
        ...
        this.loadIncludeScript("publishing013.xfdl");
