(function()
{
    return function()
    {
        ...
        {
            this.set_name("publishing023");
            this.set_titletext("프로그램메시지관리");
            ...
            obj = new Grid("Grid01","300","97",null,null,"10","259",null,null,null,null,this);
            obj.set_taborder("10");
        ...
        this.loadIncludeScript("publishing023.xfdl");
