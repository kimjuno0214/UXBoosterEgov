(function()
{
    return function()
    {
        ...
        {
            this.set_name("publishing032");
            this.set_titletext("개인설정팝업");
            ...
            obj = new Button("Button01","150","105","100","23",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("비밀번호변경");
            obj.set_cssclass("btn_WF_basic01");
            this.addChild(obj.name, obj);

            obj = new Button("Button02","Button01:7","105","100","23",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("마이메뉴설정");
            obj.set_cssclass("btn_WF_basic01");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("Button10","Button04:7","136","50","23",null,null,null,null,null,null,this);
            obj.set_taborder("27");
            obj.set_text("삭제");
            obj.set_cssclass("btn_WF_basic01");
            this.addChild(obj.name, obj);
        ...
        this.loadIncludeScript("publishing032.xfdl");
