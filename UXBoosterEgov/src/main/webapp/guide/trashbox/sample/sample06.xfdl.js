(function()
{
    return function()
    {
        ...
        {
            this.set_name("sample6");
            this.set_titletext("Layout6");
            ...
            obj = new Static("Static49","420","1",null,"30","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("3");
            obj.set_text("서브타이틀2");
            obj.set_cssclass("sta_WF_title02");
            this.divDetail.addChild(obj.name, obj);

            obj = new Grid("grdSub","420","Static49:0",null,"250","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("4");
            obj.set_binddataset("dsSubList");
            obj.set_autofittype("col");
            obj.set_cellsizebandtype("allband");
            obj.set_cellsizingtype("both");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"120\"/><Column size=\"480\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\" \" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"데이터1\"/><Cell col=\"2\" text=\"데이터2\"/></Band><Band id=\"body\"><Cell text=\"bind:CHK\" edittype=\"checkbox\" textAlign=\"center\" displaytype=\"checkboxcontrol\"/><Cell col=\"1\" text=\"bind:Column0\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:Column1\" textAlign=\"left\"/></Band></Format></Formats>");
            this.divDetail.addChild(obj.name, obj);

            obj = new Button("btnSave",null,"4","46","23","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("6");
            obj.set_text("저장");
            obj.set_cssclass("btn_WF_basic01");
            this.divDetail.addChild(obj.name, obj);

            obj = new Button("btnDel",null,"4","46","23","btnSave:3",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("5");
            obj.set_text("삭제");
            obj.set_cssclass("btn_WF_basic01");
            this.divDetail.addChild(obj.name, obj);
            ...
            obj = new Static("Static00","420","291",null,"30","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("8");
            obj.set_text("서브타이틀2");
            obj.set_cssclass("sta_WF_title02");
            this.divDetail.addChild(obj.name, obj);

            obj = new Grid("grdSub00","420","321",null,null,"0","0",null,null,null,null,this.divDetail.form);
            obj.set_taborder("9");
            obj.set_binddataset("dsSubList");
            obj.set_autofittype("col");
            obj.set_cellsizebandtype("allband");
            ...
            obj = new Static("Static06","420","281",null,"10","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("13");
            obj.set_text("10");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
