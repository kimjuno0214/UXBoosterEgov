(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("Div02","10","10","800","361",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_cssclass("dvi_WF_tabBox01");
            this.addChild(obj.name, obj);

            obj = new Static("Static03","10","10","100","31",null,null,null,null,null,null,this.Div02.form);
            obj.set_taborder("0");
            obj.set_text("일시");
            obj.set_cssclass("sta_WF_th01L");
            this.Div02.addChild(obj.name, obj);

            obj = new Static("Static10","108","10","340","31",null,null,null,null,null,null,this.Div02.form);
            obj.set_taborder("1");
            obj.set_cssclass("sta_WF_td01L");
            this.Div02.addChild(obj.name, obj);

            obj = new Button("Button02",null,"51","100","23","10",null,null,null,null,null,this.Div02.form);
            obj.set_taborder("2");
            obj.set_text("엑셀 Download ");
            obj.set_cssclass("btn_WF_basic01");
            this.Div02.addChild(obj.name, obj);

            obj = new Static("Static00","545","10",null,"31","10",null,null,null,null,null,this.Div02.form);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_td01L");
            this.Div02.addChild(obj.name, obj);

            obj = new Static("Static01","447","10","100","31",null,null,null,null,null,null,this.Div02.form);
            obj.set_taborder("6");
            obj.set_text("구분");
            obj.set_cssclass("sta_WF_th01L");
            this.Div02.addChild(obj.name, obj);

            obj = new Calendar("Calendar00","115","15","110","21",null,null,null,null,null,null,this.Div02.form);
            obj.set_taborder("7");
            this.Div02.addChild(obj.name, obj);

            obj = new Calendar("Calendar01","235","15","110","21",null,null,null,null,null,null,this.Div02.form);
            obj.set_taborder("8");
            this.Div02.addChild(obj.name, obj);

            obj = new Combo("Combo00","554","15","80","21",null,null,null,null,null,null,this.Div02.form);
            obj.set_taborder("3");
            obj.set_text("Combo00");
            this.Div02.addChild(obj.name, obj);

            obj = new Combo("Combo01","639","15","80","21",null,null,null,null,null,null,this.Div02.form);
            obj.set_taborder("4");
            obj.set_text("Combo00");
            this.Div02.addChild(obj.name, obj);

            obj = new Grid("Grid00","10","79",null,"270","10",null,null,null,null,null,this.Div02.form);
            obj.set_taborder("9");
