(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("Div02","10","27",null,"723","10",null,null,null,null,null,this);
            obj.set_taborder("6");
            ...
            obj = new ListView("ListView00","10","236","998","472",null,null,null,null,null,null,this.Div02.form);
            obj.set_taborder("2");
            ...
            obj = new Static("Static03","284","30","100","40",null,null,null,null,null,null,this.Div02.form);
            obj.set_taborder("7");
            obj.set_text("123건");
            obj.set_cssclass("sta_WF_cellCategory01");
            this.Div02.addChild(obj.name, obj);

            obj = new Static("Static04","459","30","100","40",null,null,null,null,null,null,this.Div02.form);
            obj.set_taborder("8");
            obj.set_text("123건");
            obj.set_cssclass("sta_WF_cellCategory02");
            this.Div02.addChild(obj.name, obj);

            obj = new Static("Static05","634","30","100","40",null,null,null,null,null,null,this.Div02.form);
            obj.set_taborder("9");
            obj.set_text("123건");
            obj.set_cssclass("sta_WF_cellCategory03");
            this.Div02.addChild(obj.name, obj);
        ...
        this.loadIncludeScript("sample18.xfdl");
