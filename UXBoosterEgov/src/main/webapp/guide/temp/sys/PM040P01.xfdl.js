(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staCode","0","26","120","31",null,null,null,null,null,null,this.divMenu.form);
            obj.set_taborder("0");
            obj.set_text("메뉴");
            obj.set_cssclass("sta_WF_th01L");
            this.divMenu.addChild(obj.name, obj);

            obj = new Static("Static10","119","26",null,"31","0",null,null,null,null,null,this.divMenu.form);
            obj.set_taborder("1");
            obj.set_cssclass("sta_WF_td01L");
            this.divMenu.addChild(obj.name, obj);

            obj = new Edit("edtMenuCd","127","30","84","23",null,null,null,null,null,null,this.divMenu.form);
            obj.set_taborder("2");
            obj.set_readonly("true");
            this.divMenu.addChild(obj.name, obj);

            obj = new Static("staCode00","0","56","120","31",null,null,null,null,null,null,this.divMenu.form);
            obj.set_taborder("3");
            obj.set_text("프로그램");
            obj.set_cssclass("sta_WF_th01L");
            this.divMenu.addChild(obj.name, obj);

            obj = new Static("Static10_00","119","56",null,"31","0",null,null,null,null,null,this.divMenu.form);
            obj.set_taborder("4");
            obj.set_cssclass("sta_WF_td01L");
            this.divMenu.addChild(obj.name, obj);

            obj = new Edit("edtMenuNm","214","30",null,"23","6",null,null,null,null,null,this.divMenu.form);
            obj.set_taborder("5");
            obj.set_readonly("true");
            this.divMenu.addChild(obj.name, obj);

            obj = new Edit("edtProgramCd","127","60","84","23",null,null,null,null,null,null,this.divMenu.form);
            obj.set_taborder("6");
            obj.set_readonly("true");
            this.divMenu.addChild(obj.name, obj);

            obj = new Edit("edtProgramNm","214","60",null,"23","6",null,null,null,null,null,this.divMenu.form);
            obj.set_taborder("7");
            obj.set_readonly("true");
            this.divMenu.addChild(obj.name, obj);

            obj = new Static("staProgDetailT","0","0",null,"21","320",null,null,null,null,null,this.divMenu.form);
            obj.set_taborder("8");
            obj.set_text("화면정보");
            ...
            obj = new Static("staProgDetailT","0","0",null,"21","320",null,null,null,null,null,this.divButton.form);
            obj.set_taborder("1");
            obj.set_text("기능버튼목록");
            obj.set_cssclass("sta_WF_title02");
            this.divButton.addChild(obj.name, obj);

            obj = new Grid("grdButton","0","26",null,null,"0","0",null,null,null,null,this.divButton.form);
            obj.set_taborder("0");
            ...
            obj = new Div("divProgram","126","230","49","36",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("가상폼");
            obj.set_async("false");
            obj.set_visible("false");
            ...
            obj = new Static("staProgDetailT","0","0",null,"21","520",null,null,null,null,null,this.divUser.form);
            obj.set_taborder("0");
            ...
            obj = new Static("staProgDetailT00","Static03_00:0","0",null,"21","149",null,null,null,null,null,this.divUser.form);
            obj.set_taborder("1");
            ...
            obj = new Grid("grdUserY","0","26",null,null,"Static03:0","0",null,null,null,null,this.divUser.form);
            obj.set_taborder("2");
            ...
            obj = new Grid("grdUserN","Static03_00:0","26",null,null,"0","0",null,null,null,null,this.divUser.form);
            obj.set_taborder("3");
            ...
            obj = new Static("Static01_01","20","divUser:0",null,"20","20",null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("H20");
            obj.set_background("#fd9da0");
            obj.set_opacity("0.5");
            ...
            obj = new Button("btnSave",null,"Static01_01:0","57","23","btnCancle:3",null,null,null,null,null,this);
            obj.set_taborder("9");
