    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Layout("default","",0,0,this.divMain.form,
                ...
                var rootobj = p;
                p = rootobj;
                p.grdSystemIcon.set_taborder("1");
                p.grdSystemIcon.set_binddataset("dsSystemIcon");
                p.grdSystemIcon.move("10","10",null,null,"10","10");

                p.stcSelect.set_taborder("1");
                p.stcSelect.set_text("선택");
                p.stcSelect.set_visible("false");
                p.stcSelect.move("339","87","27","26",null,null);
            	}
            );
            ...
            this.divMain.form.addLayout(obj.name, obj);
            //-- Default Layout : this
            obj = new Layout("default","",420,430,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                p = rootobj;
                p.set_titletext("프로젝트관리_메뉴관리_아이콘등록팝업");
