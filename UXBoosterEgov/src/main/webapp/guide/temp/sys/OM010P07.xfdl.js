(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static02","10","10",null,null,"10","43",null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new WebBrowser("wbWebEditor","17","20",null,null,"20","53",null,null,null,null,this);
            obj.set_taborder("3");
            this.addChild(obj.name, obj);

            obj = new Static("Static04","0","660",null,"10","0",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("10");
            obj.set_background("red");
            obj.set_visible("false");
            ...
            obj = new Button("btnCancle","980","Static02:10","58","23",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_cssclass("btn_WF_cancel01");
            obj.set_text("취소");
            this.addChild(obj.name, obj);

            obj = new Button("btnSave",null,"Static02:10","54","23","btnCancle:3",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("확인");
