(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("edtProjectNm","Static05:10","10","195","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboType","Static00:10","10","195","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            ...
            obj = new Combo("cboUseYn","Static01:10","10","195","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            ...
            obj = new Static("staProjectInfoT","10","73",null,"21","1199",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("프로젝트목록");
            obj.set_cssclass("sta_WF_title02");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid00","10","99",null,null,"10","10",null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Button("Button01","48.16%","43","60","10",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            ...
            switch(sId)
            {
                case "List" : 		// 프로젝트 정보 조회 콜백
        			if (this.dsProjectInfo.rowcount > 0){
        				...
        				//this.staProjectInfoT.set_text("프로젝트목록 ("+nRowCount+"건)");
        			} else {
        				//this.staProjectInfoT.set_text("프로젝트목록 (0건)");
        			}
