(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staSystemLicenseTitle","20","106","138","31",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("License 정보");
            obj.set_cssclass("sta_WF_th01L");
            this.addChild(obj.name, obj);

            obj = new Static("Static10","157","46",null,"31","20",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_cssclass("sta_WF_td01L");
            this.addChild(obj.name, obj);

            obj = new Static("Static11","157","76","371","31",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_cssclass("sta_WF_td01L");
            this.addChild(obj.name, obj);

            obj = new Static("staSystemLicense","157","106",null,"31","20",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_td01L");
            obj.set_text("License 정보");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSystemNm","165","51","274","21",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_cssclass("edt_WF_essential");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSystemVersion","166","81","274","21",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_cssclass("edt_WF_essential");
            this.addChild(obj.name, obj);

            obj = new Static("staDescTxtTitle","20","136","138","94",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("상세설명");
            obj.set_cssclass("sta_WF_th01L");
            this.addChild(obj.name, obj);

            obj = new Static("Static01","157","136",null,"94","20",null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_cssclass("sta_WF_td01L");
            this.addChild(obj.name, obj);

            obj = new Edit("edtManagerNm","592","51","274","21",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_cssclass("edt_WF_essential");
            this.addChild(obj.name, obj);

            obj = new Button("btnManager","edtManagerNm:3","51","21","21",null,null,null,null,null,null,this);
            obj.set_taborder("25");
            obj.set_cssclass("btn_WF_search02");
            this.addChild(obj.name, obj);

            obj = new Static("staLastDeployDtTitle","447","76","138","31",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("최종배포일시");
            obj.set_cssclass("sta_WF_th01L");
            this.addChild(obj.name, obj);

            obj = new Static("staLastDeployDt","585","76",null,"31","20",null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_cssclass("sta_WF_td01L");
            obj.set_text("최종배포일시");
            this.addChild(obj.name, obj);

            obj = new TextArea("txtDescTxt","staDescTxtTitle:7","141",null,"85","27",null,null,null,null,null,this);
            obj.set_taborder("14");
            this.addChild(obj.name, obj);

            obj = new Button("btnTab02","334","240","156","27",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("약관등록");
            obj.set_cssclass("btn_WF_tab01");
            this.addChild(obj.name, obj);

            obj = new Button("btnTab01","177","240","156","27",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("이미지등록");
            obj.set_cssclass("btn_WF_tab01");
            this.addChild(obj.name, obj);

            obj = new Button("btnTab00","20","240","156","27",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("배포이력");
            obj.set_cssclass("btn_WF_tab02");
            this.addChild(obj.name, obj);

            obj = new Div("divTab00","20","267",null,null,"20","20",null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_cssclass("dvi_WF_tabBox01");
            obj.set_text("divTab00");
            this.addChild(obj.name, obj);

            obj = new Grid("gridSystemDeploy","10","36",null,null,"10","10",null,null,null,null,this.divTab00.form);
            obj.set_taborder("0");
            ...
            obj = new Button("btnDeploySave",null,"10","46","21","10",null,null,null,null,null,this.divTab00.form);
            obj.set_taborder("1");
            obj.set_text("저장");
            obj.set_cssclass("btn_WF_save02");
            this.divTab00.addChild(obj.name, obj);

            obj = new Button("btnDeployDel",null,"10","46","21","60",null,null,null,null,null,this.divTab00.form);
            obj.set_taborder("2");
            obj.set_text("삭제");
            obj.set_cssclass("btn_WF_cancel02");
            this.divTab00.addChild(obj.name, obj);

            obj = new Button("btnDeployAdd",null,"10","46","21","110",null,null,null,null,null,this.divTab00.form);
            obj.set_taborder("3");
            obj.set_text("추가");
            obj.set_cssclass("btn_WF_plus01");
            this.divTab00.addChild(obj.name, obj);

            obj = new Button("btnTab03","491","240","156","27",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_text("로그인정책");
            obj.set_cssclass("btn_WF_tab01");
            this.addChild(obj.name, obj);

            obj = new Button("btnTab04","648","240","156","27",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            ...
            obj = new Static("Static05","408","67","200","246",null,null,null,null,null,null,this.divTab01.form);
            obj.set_taborder("0");
            obj.set_cssclass("sta_WF_td01L");
            this.divTab01.addChild(obj.name, obj);

            obj = new Static("Static06","607","67","200","246",null,null,null,null,null,null,this.divTab01.form);
            obj.set_taborder("1");
            obj.set_cssclass("sta_WF_td01L");
            this.divTab01.addChild(obj.name, obj);

            obj = new Static("Static07","806","67",null,"246","10",null,null,null,null,null,this.divTab01.form);
            obj.set_taborder("2");
            obj.set_cssclass("sta_WF_td01L");
            this.divTab01.addChild(obj.name, obj);

            obj = new Button("btnSaveSub",null,"10","46","21","10",null,null,null,null,null,this.divTab01.form);
            obj.set_taborder("3");
            obj.set_text("저장");
            obj.set_cssclass("btn_WF_save02");
            this.divTab01.addChild(obj.name, obj);

            obj = new Static("staBanner","408","36",null,"31","10",null,null,null,null,null,this.divTab01.form);
            obj.set_taborder("6");
            ...
            obj = new Static("Static02","10","67","200","246",null,null,null,null,null,null,this.divTab01.form);
            obj.set_taborder("7");
            obj.set_cssclass("sta_WF_td01L");
            this.divTab01.addChild(obj.name, obj);

            obj = new Static("Static04","209","67","200","246",null,null,null,null,null,null,this.divTab01.form);
            obj.set_taborder("8");
            obj.set_cssclass("sta_WF_td01L");
            this.divTab01.addChild(obj.name, obj);

            obj = new ImageViewer("imgLogin","25","85","169","144",null,null,null,null,null,null,this.divTab01.form);
            obj.set_taborder("9");
            obj.set_stretch("fit");
            obj.set_background("#e0e0e0");
            this.divTab01.addChild(obj.name, obj);

            obj = new ImageViewer("imgTop","226","85","169","144",null,null,null,null,null,null,this.divTab01.form);
            obj.set_taborder("10");
            obj.set_stretch("fit");
            this.divTab01.addChild(obj.name, obj);

            obj = new ImageViewer("imgBanner01","422","85","169","144",null,null,null,null,null,null,this.divTab01.form);
            obj.set_taborder("11");
            obj.set_stretch("fit");
            this.divTab01.addChild(obj.name, obj);

            obj = new ImageViewer("imgBanner02","623","85","169","144",null,null,null,null,null,null,this.divTab01.form);
            obj.set_taborder("12");
            obj.set_stretch("fit");
            this.divTab01.addChild(obj.name, obj);

            obj = new ImageViewer("imgBanner03","822","85","169","144",null,null,null,null,null,null,this.divTab01.form);
            obj.set_taborder("13");
            obj.set_stretch("fit");
            this.divTab01.addChild(obj.name, obj);

            obj = new Button("btnLogoUploadSub1","75","imgLogin:55","69","21",null,null,null,null,null,null,this.divTab01.form);
            obj.set_taborder("14");
            obj.set_text("업로드");
            obj.set_cssclass("btn_WF_AttachedFile");
            this.divTab01.addChild(obj.name, obj);

            obj = new Button("btnLogoUploadSub2","275","imgTop:55","69","21",null,null,null,null,null,null,this.divTab01.form);
            obj.set_taborder("15");
            obj.set_text("업로드");
            obj.set_cssclass("btn_WF_AttachedFile");
            this.divTab01.addChild(obj.name, obj);

            obj = new Button("btnBannerUploadSub2","677","imgBanner02:55","69","21",null,null,null,null,null,null,this.divTab01.form);
            obj.set_taborder("16");
            obj.set_text("업로드");
            obj.set_cssclass("btn_WF_AttachedFile");
            this.divTab01.addChild(obj.name, obj);

            obj = new Button("btnBannerUploadSub1","474","imgBanner01:55","69","21",null,null,null,null,null,null,this.divTab01.form);
            obj.set_taborder("17");
            obj.set_text("업로드");
            obj.set_cssclass("btn_WF_AttachedFile");
            this.divTab01.addChild(obj.name, obj);

            obj = new Button("btnBannerUploadSub3","874","imgBanner03:55","69","21",null,null,null,null,null,null,this.divTab01.form);
            obj.set_taborder("18");
            obj.set_text("업로드");
            obj.set_cssclass("btn_WF_AttachedFile");
            this.divTab01.addChild(obj.name, obj);

            obj = new Static("staLogo1","10","36","200","31",null,null,null,null,null,null,this.divTab01.form);
            obj.set_taborder("4");
            ...
            obj = new Static("staLogo2","209","36","200","31",null,null,null,null,null,null,this.divTab01.form);
            obj.set_taborder("5");
            ...
            obj = new Button("btnPolicySave",null,"10","46","21","10",null,null,null,null,null,this.divTab02.form);
            obj.set_taborder("1");
            obj.set_text("저장");
            obj.set_cssclass("btn_WF_save02");
            this.divTab02.addChild(obj.name, obj);
            ...
            obj = new Button("btnLoginPolicySave",null,"10","46","21","10",null,null,null,null,null,this.divTab03.form);
            obj.set_taborder("0");
            obj.set_text("저장");
            obj.set_cssclass("btn_WF_save02");
            ...
            obj = new Static("staImpossibleTxtTitle","494","37","220","181",null,null,null,null,null,null,this.divTab03.form);
            obj.set_taborder("13");
            obj.set_text("비밀번호 포함 불가 문자열");
            obj.set_cssclass("sta_WF_th01L");
            this.divTab03.addChild(obj.name, obj);

            obj = new Static("Static00","713","37",null,"181","15",null,null,null,null,null,this.divTab03.form);
            obj.set_taborder("14");
            obj.set_cssclass("sta_WF_td01L");
            this.divTab03.addChild(obj.name, obj);
            ...
            obj = new Button("btnLoginPolicyPlus",null,"159","28","23","18",null,null,null,null,null,this.divTab03.form);
            obj.set_taborder("21");
            obj.set_cssclass("btn_WF_Open");
            this.divTab03.addChild(obj.name, obj);

            obj = new Button("btnLoginPolicyMinus",null,"189","28","23","18",null,null,null,null,null,this.divTab03.form);
            obj.set_taborder("22");
            obj.set_cssclass("btn_WF_Fold");
            this.divTab03.addChild(obj.name, obj);

            obj = new Grid("grdImpossibleTxt","720","42",null,"171","50",null,null,null,null,null,this.divTab03.form);
            obj.set_taborder("23");
            ...
            obj = new Button("btnButtonSave",null,"5","46","21","10",null,null,null,null,null,this.divTab04.form);
            obj.set_taborder("0");
            obj.set_text("저장");
            obj.set_cssclass("btn_WF_save02");
            ...
            obj = new Edit("edtShortcutInput","137","42","354","21",null,null,null,null,null,null,this.divTab04.form);
            obj.set_taborder("13");
            this.divTab04.addChild(obj.name, obj);

            obj = new Edit("edtShortcutDelete","137","72","354","21",null,null,null,null,null,null,this.divTab04.form);
            obj.set_taborder("14");
            this.divTab04.addChild(obj.name, obj);

            obj = new Edit("edtShortcutSave","137","102","354","21",null,null,null,null,null,null,this.divTab04.form);
            obj.set_taborder("15");
            this.divTab04.addChild(obj.name, obj);

            obj = new Edit("edtShortcutPrint","137","132","354","21",null,null,null,null,null,null,this.divTab04.form);
            obj.set_taborder("16");
            this.divTab04.addChild(obj.name, obj);

            obj = new Edit("edtShortcutExcel","137","162","354","21",null,null,null,null,null,null,this.divTab04.form);
            obj.set_taborder("17");
            this.divTab04.addChild(obj.name, obj);

            obj = new Edit("edtShortcutManual","137","192","354","21",null,null,null,null,null,null,this.divTab04.form);
            obj.set_taborder("18");
            this.divTab04.addChild(obj.name, obj);

            obj = new Edit("edtManagerCd","773","51","80","21",null,null,null,null,null,null,this);
            obj.set_taborder("26");
            obj.set_readonly("true");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("staHolidayListT","20","20","493","21",null,null,null,null,null,null,this);
            obj.set_taborder("27");
            obj.set_text("기본정보");
            obj.set_cssclass("sta_WF_title02");
            this.addChild(obj.name, obj);

            obj = new Button("btnDemoId",null,"20","80","21","20",null,null,null,null,null,this);
            obj.set_taborder("28");
            obj.set_text("데모ID생성");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Button("btnFwDownload",null,"20","130","21","103",null,null,null,null,null,this);
            obj.set_taborder("29");
            obj.set_text("Framework다운로드");
            obj.set_visible("false");
            this.addChild(obj.name, obj);

            obj = new Static("staSystemNmTitle","20","46","138","31",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("시스템 명");
            obj.set_cssclass("sta_WF_th01L");
            this.addChild(obj.name, obj);

            obj = new Static("staSystemVersionTitle","20","76","138","31",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Version");
            obj.set_cssclass("sta_WF_th01L");
            this.addChild(obj.name, obj);

            obj = new Static("staManagerNmTitle","447","46","138","31",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("담당자");
            obj.set_cssclass("sta_WF_th01L");
            this.addChild(obj.name, obj);
        ...
        ********************************************************/
        ...
        this.fnCheckForm = function()
        {
            ...
            if(sSystemNm == ""){
                //alert("시스템명을 작성해주세요.");
        		take.alert(this, "Info", "MS00000014", {text:this.staSystemNmTitle.text});
            ...
            if(sManagerNm == ""){
                //alert("담당자명을 작성해주세요.");
        		take.alert(this, "Info", "MS00000014", {text:this.staManagerNmTitle.text});
                this.edtManagerNm.setFocus();
                return false;
            }

            if(sVersionNm == ""){
                //alert("시스템 버전명을 작성해주세요.");
        		take.alert(this, "Info", "MS00000014", {text:this.staSystemVersionTitle.text});
        ...
        this.FileUpTransfer00_onsuccess = function(obj,e)
        {
        	...
        	take.alert(this, "Info", "MS00000004", {text : sMsg});
