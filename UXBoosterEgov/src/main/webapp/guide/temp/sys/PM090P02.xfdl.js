    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Layout("default","",0,0,this.divSearch.form,
                ...
                var rootobj = p;
                p = rootobj;
                p.staMenuNmT.set_taborder("0");
                p.staMenuNmT.set_text("메뉴명/코드");
                p.staMenuNmT.set_cssclass("sta_WF_textR");
                p.staMenuNmT.move("10","10","80","21",null,null);

                p.edtMenuNm.set_taborder("1");
                p.edtMenuNm.move("staMenuNmT:10","10",null,"21","7",null);
            	}
            );
            ...
            obj = new Layout("default","",0,0,this.divDetail.form,
                ...
                p.Static24.set_text("메뉴 목록");
                p.Static24.set_cssclass("sta_WF_title02");
                p.Static24.move("0","10",null,"20","0",null);

                p.grdList.set_taborder("1");
                p.grdList.set_autofittype("col");
                p.grdList.set_binddataset("dsMenuCd");
                p.grdList.move("0","Static24:5",null,null,"0","0");
            	}
            );
            ...
            obj = new Layout("default","",480,470,this,
                ...
                var rootobj = p;
                p = rootobj;
                p.set_titletext("대시보드_대시보드관리_메뉴선택팝업");
                ...
                p.btnShowHide.move("43.75%","divSearch:0","60","10",null,null);

                p.divDetail.set_taborder("6");
                p.divDetail.set_text("");
                p.divDetail.move("20","btnShowHide:20",null,null,"20","63");

                p.btnMenuSearch.set_taborder("2");
                p.btnMenuSearch.set_cssclass("btn_WF_search03");
                p.btnMenuSearch.set_text("조회");
                p.btnMenuSearch.move(null,"20","46","21","20",null);
                ...
                p.Static01_00_00.set_taborder("4");
                ...
                p.Static01_00_01.set_taborder("5");
                ...
                p.Static01.move("0","450",null,"20","0",null);
            ...
            obj = new BindItem("item0","divSearch.form.edtMenuNm","value","dsSearch","USER_CD");
            this.addChild(obj.name, obj);
            obj.bind();
