(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static01_01","0","427",null,"20","0",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("");
            ...
            obj = new Button("btnClose",null,"divDetail:20","58","23","20",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_cssclass("btn_WF_cancel01");
            obj.set_text("취소");
            this.addChild(obj.name, obj);

            obj = new Button("btnConfirm",null,"divDetail:20","58","23","btnClose:3",null,null,null,null,null,this);
            obj.set_taborder("4");
