(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_background("#fffff");
            if (Form == this.constructor)
            {
                this._setFormPosition(661,549);
            }
            ...
            obj._setContents("<ColumnInfo><Column id=\"USER_ID\" type=\"STRING\" size=\"256\"/><Column id=\"USER_CD\" type=\"STRING\" size=\"256\"/><Column id=\"USER_NM\" type=\"STRING\" size=\"256\"/><Column id=\"PROJECT_CD\" type=\"STRING\" size=\"256\"/><Column id=\"BRAN_CD\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divSearch","20","46",null,"101","20",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_cssclass("div_WF_searchBox01");
            this.addChild(obj.name, obj);

            obj = new Static("staCode","10","39","80","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("대상자 ID");
            obj.set_cssclass("sta_WF_textR");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staName","10","68","80","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("대상자 성명");
            obj.set_cssclass("sta_WF_textR");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtId","staCode:10","39",null,"21","340",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtName","staName:10","68",null,"21","340",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_imemode("alpha");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staName00","10","10","80","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("지점");
            obj.set_cssclass("sta_WF_textR");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboBranCd","staName00:10","10","179","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("5");
            ...
            obj = new Button("btnShowHide","45.39%","divSearch:0","60","10",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"110\"/><Column size=\"110\"/><Column size=\"110\"/><Column size=\"90\"/><Column size=\"100\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"0\"/><Cell col=\"1\" text=\"지점\"/><Cell col=\"2\" text=\"대리점\"/><Cell col=\"3\" text=\"아이디\"/><Cell col=\"4\" text=\"대상자\"/><Cell col=\"5\" text=\"코드\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\"/><Cell col=\"1\" text=\"expr:BRAN_NM\" textAlign=\"center\"/><Cell col=\"2\" text=\"expr:SHOP_NM\" textAlign=\"left\"/><Cell col=\"3\" text=\"bind:TARGET_ID\" textAlign=\"center\"/><Cell col=\"4\" text=\"bind:TARGET_NM\" textAlign=\"left\"/><Cell col=\"5\" text=\"bind:TARGET_CD\" textAlign=\"center\"/></Band></Format></Formats>");
            ...
            obj = new Static("Static01_00_00","20","486",null,"20","20",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("H20");
            ...
            obj = new Static("Static01_00_00_00","20","529",null,"20","20",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("H20");
            obj.set_background("#fd9da0");
            obj.set_opacity("0.5");
            ...
            obj = new Static("Static01_00_00_01","20","157",null,"20","20",null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("H20");
            obj.set_background("#fd9da0");
            obj.set_opacity("0.5");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",661,549,this,function(p){});
            obj.set_mobileorientation("landscape");
            this.addLayout(obj.name, obj);
            
            // BindItem Information
            obj = new BindItem("item0","divSearch.form.edtId","value","dsSearch","USER_ID");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","divSearch.form.edtName","value","dsSearch","USER_NM");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divSearch.form.cboBranCd","value","dsSearch","BRAN_CD");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        */
        ...
        this.divSearch_staCode_onclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divSearch.form.edtId.addEventHandler("onkeyup",this.Edit_onkeyup,this);
