(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnAllDown",null,"16","70","21","8",null,null,null,null,null,this.divMain00.form.divFile.form);
            obj.set_taborder("1");
            obj.set_text("일괄다운");
            this.divMain00.form.divFile.addChild(obj.name, obj);

            obj = new CheckBox("chkClose","0",null,"300","20",null,"13",null,null,null,null,this.divMain00.form);
            obj.set_taborder("4");
            ...
            obj = new Button("btnAllDown",null,"16","70","21","8",null,null,null,null,null,this.divMain01.form.divFile.form);
            obj.set_taborder("0");
            obj.set_text("일괄다운");
            this.divMain01.form.divFile.addChild(obj.name, obj);

            obj = new CheckBox("chkClose","0",null,"300","20",null,"13",null,null,null,null,this.divMain01.form);
            obj.set_taborder("4");
            obj.set_text("오늘하루그만보기");
            this.divMain01.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chkClose","0",null,"300","20",null,"13",null,null,null,null,this.divMain02.form);
            obj.set_taborder("4");
            obj.set_text("오늘하루그만보기");
            this.divMain02.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chkClose","0",null,"300","20",null,"13",null,null,null,null,this.divMain03.form);
            obj.set_taborder("4");
            obj.set_text("오늘하루그만보기");
            this.divMain03.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chkClose","0",null,"300","20",null,"13",null,null,null,null,this.divMain04.form);
            obj.set_taborder("4");
            obj.set_text("오늘하루그만보기");
            this.divMain04.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chkClose","0",null,"300","20",null,"13",null,null,null,null,this.divMain05.form);
            obj.set_taborder("4");
            obj.set_text("오늘하루그만보기");
            this.divMain05.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chkClose","0",null,"300","20",null,"13",null,null,null,null,this.divMain06.form);
            obj.set_taborder("4");
            obj.set_text("오늘하루그만보기");
            this.divMain06.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chkClose","0",null,"300","20",null,"13",null,null,null,null,this.divMain07.form);
            obj.set_taborder("4");
            obj.set_text("오늘하루그만보기");
            this.divMain07.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chkClose","0",null,"300","20",null,"13",null,null,null,null,this.divMain08.form);
            obj.set_taborder("4");
            obj.set_text("오늘하루그만보기");
            this.divMain08.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chkClose","0",null,"300","20",null,"13",null,null,null,null,this.divMain09.form);
            obj.set_taborder("4");
            obj.set_text("오늘하루그만보기");
            this.divMain09.addChild(obj.name, obj);
        ...
        */
        ...
        {
        	this.ProgId = "GM00000039";
        	this.ProgNm = "GM00000039";
        ...
        this.CM040P01_ontimer = function(obj,e)
        {
        	if (e.timerid==1)
        	{
        		if (this.fv_bWebOnload == true)
        		{
        			...
        			//20200701 정해원 eSCM수정요청 사항
        			//1 page - 자동슬라이드
        			this.setTimer(991,5000);
        		}
        	}else if(e.timerid==991){
        		//20200701 정해원 eSCM수정요청 사항
        		//1 page - 자동슬라이드
        		var nStepIndex = this.getStepIndex();
        		var nStepCount = this.getStepCount();

        		if(nStepCount == (nStepIndex+1)){
        			this.setStepIndex(0);
        		}else{
        			nStepIndex++;
