(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnClose","772","607","58","23",null,null,null,null,null,null,this);
            obj.set_taborder("13");
        ...
        */
        ...
        {
        	this.ProgId = "GM00000041";
        	this.ProgNm = "GM00000041";
        ...
        ********************************************************/
        ...
        this.livReply_oncellclick = function(obj,e)
        {
        	...
        	if(sCellTxt == "삭제")
        	{
        		...
        		var bDel = take.confirm(this, "question", "MS00000071");
        		if(bDel)
        		{
        ...
        this.fnCallback = function(sId, nErrCd, sErrMsg)
        {
            ...
            switch(sId)
            {
        		...
        		case "ReplyModify" : //댓글 수정 콜백
        			...
        			take.alert(this, "Info", "MS00000005");
        			this.fnReplySearch();
