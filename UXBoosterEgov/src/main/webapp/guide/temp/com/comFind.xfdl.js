(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Radio("rdoDirection","114","74",null,"23","80",null,null,null,null,null,this);
            obj.set_taborder("20");
        ...
        // User Script
        this.registerScript("comFind.xfdl", function() {
        /***************************************************************************************************
         * 업무구분		: 포탈(대시보드) 시스템 구축
         * 화 면 명		: comFind.xfdl
         * 화면설명		: 그리드 공통 찾기 팝업
        ...
        this.loadIncludeScript("comFind.xfdl");
