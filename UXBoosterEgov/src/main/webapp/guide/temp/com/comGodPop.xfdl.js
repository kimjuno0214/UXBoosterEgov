(function()
{
    return function()
    {
        ...
        {
            this.set_name("comGodPop");
            this.set_titletext("품목선택");
            ...
            obj = new Button("btnShowHide","46.25%","divSearch:0","60","10",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"173\"/><Column size=\"100\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"품목코드\"/><Cell col=\"1\" text=\"품목명\"/><Cell col=\"2\" text=\"품목구분\"/></Band><Band id=\"body\"><Cell text=\"bind:GOD_CD\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:GOD_NM\" textAlign=\"left\"/><Cell col=\"2\" text=\"bind:GOD_DIV_NM\" textAlign=\"center\"/></Band></Format></Formats>");
            ...
            obj = new Static("Static01_01","20","divDetail:0",null,"20","20",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("H20");
            ...
            obj = new Static("Static01","20","btnEnter:0",null,"20","20",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("H20");
            obj.set_background("#fd9da0");
            obj.set_opacity("0.5");
        ...
        // User Script
        this.registerScript("comGodPop.xfdl", function() {
        /**
        *  품목찾기팝업
        *
        *  @MenuPath    공통 > 품목찾기팝업
        ...
        */
        this.comGodPop_onload = function(obj, e)
        {
        ...
        */
        ...
        {
            this.addEventHandler("onload",this.comGodPop_onload,this);
        ...
        this.loadIncludeScript("comGodPop.xfdl");
