(function()
{
    return function()
    {
        ...
        {
            this.set_name("comExpCstPop");
            this.set_titletext("수출거래처선택");
        ...
        // User Script
        this.registerScript("comExpCstPop.xfdl", function() {
        /**
        *  수출거래처찾기팝업
        *
        ...
        */
        ...
        this.loadIncludeScript("comExpCstPop.xfdl");
