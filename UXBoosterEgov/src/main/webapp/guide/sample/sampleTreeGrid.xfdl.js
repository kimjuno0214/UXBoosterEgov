(function()
{
    return function()
    {
        ...
        {
            this.set_name("sampleTreeGrid");
            this.set_titletext("(샘플)드래그&드랍 트리");
            ...
            obj = new Grid("grdTree","10","20","370","420",null,null,null,null,null,null,this);
            obj.set_binddataset("dsOrg");
            obj.set_treeusecheckbox("false");
            obj.set_treeinitstatus("expand,null");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"301\"/></Columns><Rows><Row size=\"30\"/></Rows><Band id=\"body\"><Cell displaytype=\"treeitemcontrol\" edittype=\"tree\" text=\"bind:NAME\" treelevel=\"bind:LEVEL\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid00","390","20","370","420",null,null,null,null,null,null,this);
            obj.set_taborder("2");
        ...
        // User Script
        this.registerScript("sampleTreeGrid.xfdl", function() {
        /**
        ...
        */
        ...
        this.loadIncludeScript("sampleTreeGrid.xfdl");
