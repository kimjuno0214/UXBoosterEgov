(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"239\"/></Columns><Rows><Row size=\"34\" band=\"head\"/><Row size=\"34\"/></Rows><Band id=\"head\"><Cell text=\"일반 Tree\"/></Band><Band id=\"body\"><Cell text=\"bind:menu_nm\" displaytype=\"treeitemcontrol\" edittype=\"tree\" treelevel=\"bind:menu_level\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("Button00","808","18","184","64",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Button00");
            this.addChild(obj.name, obj);

            obj = new Static("Static00","878","132","75","33",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Button("Button01","905","212","111","36",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"239\"/></Columns><Rows><Row size=\"34\" band=\"head\"/><Row size=\"34\"/></Rows><Band id=\"head\"><Cell text=\"Take Tree\"/></Band><Band id=\"body\"><Cell text=\"bind:menu_nm\" displaytype=\"treeitemcontrol\" edittype=\"tree\" treelevel=\"bind:menu_level\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid00","482","10","235","654",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_binddataset("dsTree");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"37\" band=\"head\"/><Row size=\"37\"/></Rows><Band id=\"head\"><Cell text=\"parent_menu\"/><Cell col=\"1\" text=\"menu_level\"/><Cell col=\"2\" text=\"menu_order\"/></Band><Band id=\"body\"><Cell text=\"bind:parent_menu\"/><Cell col=\"1\" text=\"bind:menu_level\"/><Cell col=\"2\" text=\"bind:menu_order\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.registerScript("smpTree.xfdl", function() {

        this.smpTree_onload = function(obj,e)
        {
            // taketree 항목
            // {
        ...
        {
            this.addEventHandler("onload",this.smpTree_onload,this);
            this.Button00.addEventHandler("onclick",this.Button00_onclick,this);
            this.Button01.addEventHandler("onclick",this.Button01_onclick,this);
        };
        this.loadIncludeScript("smpTree.xfdl");
