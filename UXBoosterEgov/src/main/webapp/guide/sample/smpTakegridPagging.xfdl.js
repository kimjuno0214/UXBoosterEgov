(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staInfo","1050","0",null,"280","-390",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("- 검색영역 높이\r\n  (검색조건은 한단에 3개씩만 세팅합니다.)\r\n  1단 : 44px\r\n  2단 : 72px\r\n  3단 : 99px\r\n\r\n- 그리드 높이\r\n   헤더 한줄 : 32px\r\n   헤더 두줄 : 47px (15px증가)\r\n   헤더 세줄 : 62px (15px 증가)\r\n   바디 : 기본 30px \r\n   가변적으로 늘어나기때문에 \r\n   해당 셀 프러퍼티 autosizerow : limitmin, wordWrap : char 로 세팅\r\n   그리드 프로퍼티 autosizingtype : row, extendsizetype : row 로 세팅");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
        ...
        // User Script
        this.registerScript("smpTakegridPagging.xfdl", function() {
        /**
        *  SYSTEM FORM NAME
        *
        ...
        this.fnSearch = function(sTranId)
        {
        	...
        	switch(sTranId) {
                case "userList":
        			...
        			var sOutDs 			= ["dsList"];
        			var sCntNameSpaces	= ["Sample.smpForm01JoinSelectCount"];
        			var sNameSpaces 	= ["smpForm01JoinSelectPage"];

                    //조회
        			take.tranSelectPage(
                        this,                              //현재 Form 객체
                        sTranId,                           //Transaction Id
                        sCntNameSpaces,//"Sample.smpForm01JoinSelectCount",       //count sqlMapperId
                        sNameSpaces,//"Sample.smpForm01JoinSelectPage",  //list sqlMapperId
                        "",                                //Indataset(서버로 보낼 dataset)
                        sOutDs,//"dsList",                          //Outdataset(서버에서 받을 dataset)
                        sParam,                            //Parameter
        ...
        */
        ...
        this.loadIncludeScript("smpTakegridPagging.xfdl");
