(function()
{
    return function()
    {
        ...
        {
            this.set_name("dbcPieChart");
            this.set_titletext("파이차트");
            ...
            obj = new PieChart("PieChart00","0","0",null,null,"0","0",null,null,null,null,this.divMain.form);
            obj.set_taborder("0");
            ...
            obj._setContents({
            	...
            	"board": {
            		...
            		"visible": "true",
            		"text": "TOTALL\n\n142,667",
            		"textfont": "normal 600 13px 'NanumGothic'",
            		"textcolor": "#333333"
            	},
            	"seriesset": [
            		{
            			...
            			"radius": "90",
            			"fillstyle": "#81ddc6,#f35e58,#edc683",
            			"selecttype": "unselect",
            			"itemtextcolor": "#777777",
            			"linestyle": "1px solid #ffffff",
            			"itemtextguidelinestyle": "0px solid #777777",
            			"highlightvisible": "true",
            			"highlightopacity": "0.5",
            			"highlightlinestyle": "0px",
        ...
        // User Script
        this.registerScript("dbcPieChart.xfdl", function() {
        /**
        *  SYSTEM FORM NAME
        *
        ...
        ********************************************************/
        ...
        {
            this.divMain.form.PieChart00.runAnimation();
         ...
         ********************************************************/
        // series 클릭 이벤트
        this.divMain_PieChart00_onseriesclick = function(obj,e)
        {
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divMain.form.PieChart00.addEventHandler("onseriesclick",this.divMain_PieChart00_onseriesclick,this);
            this.staToday.addEventHandler("onclick",this.staToday_onclick,this);
        };
        this.loadIncludeScript("dbcPieChart.xfdl");
