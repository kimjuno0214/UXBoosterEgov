(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"104\"/><Column size=\"500\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/><Row size=\"24\" band=\"summ\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" border=\"0px none,0px none,1px solid #afb8cf\"/><Cell col=\"1\" text=\"파일구분\" border=\"0px none,0px none,1px solid #afb8cf\"/><Cell col=\"2\" text=\"파일명\" border=\"0px none,0px none,1px solid #afb8cf\"/><Cell col=\"3\" text=\"파일크기(KB)\" border=\"0px none,0px none,1px solid #afb8cf\"/><Cell col=\"4\" text=\"등록일\" border=\"0px none,0px none,1px solid #afb8cf\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:CHK\" border=\"0px none\"/><Cell col=\"1\" displaytype=\"combotext\" edittype=\"combo\" combodataset=\"dsAtchFileTypeCd\" combocodecol=\"CODE\" combodatacol=\"NAME\" text=\"bind:FILE_TYPE\" border=\"0px none\"/><Cell col=\"2\" text=\"bind:FILE_NM\" cursor=\"pointer\" color=\"blue\" border=\"0px none\"/><Cell col=\"3\" text=\"bind:FILE_SIZE\" displaytype=\"number\" textAlign=\"right\" border=\"0px none\"/><Cell col=\"4\" textAlign=\"center\" text=\"bind:REG_DT\" calendardateformat=\"yyyy-MM-dd\" displaytype=\"date\" calendardisplaynulltype=\"none\" border=\"0px none\"/></Band><Band id=\"summary\"><Cell colspan=\"3\" border=\"1px solid #afb8cf,0px none,\"/><Cell col=\"3\" displaytype=\"number\" text=\"expr:dataset.getSum(&quot;nexacro.toNumber(FILE_SIZE)&quot;)\" border=\"1px solid #afb8cf,0px none,\"/><Cell col=\"4\" text=\"다운로드\" cursor=\"pointer\" border=\"1px solid #afb8cf,0px none,\" displaytype=\"buttoncontrol\" edittype=\"button\" padding=\"2px 10px\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.registerScript("comFileSYS.xfdl", function() {
        /**
         *  SYSTEM FORM NAME
         *
         *  @MenuPath    -
        ...
        ********************************************************/
        ...
        this.loadIncludeScript("comFileSYS.xfdl");
