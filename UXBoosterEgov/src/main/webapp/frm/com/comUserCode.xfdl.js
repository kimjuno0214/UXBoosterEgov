    ...
    return function()
    {
        ...
        ********************************************************/
        ...
        this.fnSearch = function(sTranId)
        {
        	...
        	this.dsSearchCode.clearData();

        	var sInDs 		= "dsSearchCode";
            var sOutDs 		= "dsList";
        	var sNameSpaces = this.fnGetNamespace();

        	var nRow = this.dsSearchCode.addRow();
        	this.dsSearchCode.setColumn(nRow, 'CODE', this.edtCode.value);

        	take.tranSelect(this, sTranId, sNameSpaces, sInDs, sOutDs, "", "fnCallback", true, "dsSearchCode");
        };
        ...
        this.edtCode_onkeydown = function(obj,e)
        {
        	if( e.keycode == 13)
            {
                ...
                if (take.nvl(this.edtCodeName.value, "")!="")
                {
        ...
        this.edtCodeName_onchanged = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.edtCodeName.addEventHandler("onchanged",this.edtCodeName_onchanged,this);
        };
