(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divMsg","0","0",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj.set_font("bold 30px/normal \"NanumGothic\"");
            obj.set_letterSpacing("-1px");
            obj.set_color("#ffffff");
            obj.set_background("#2f2f41");
            obj.set_textAlign("center");
            this.divMsg.addChild(obj.name, obj);

            obj = new Button("btnSub","120",null,"120","50",null,"0",null,null,null,null,this.divMsg.form);
            obj.set_taborder("6");
            obj.set_text("서브");
            ...
            obj.set_cssclass("sta_GA_Title2");
            obj.set_usedecorate("true");
            obj.set_wordWrap("char");
            obj.set_font("bold 15px/normal \"NanumGothic\"");
            obj.set_letterSpacing("0px");
            this.divMsg.addChild(obj.name, obj);

            obj = new Button("btnOk",null,null,"180","50","0","0",null,null,null,null,this.divMsg.form);
            obj.set_taborder("4");
            obj.set_text("확인");
            obj.set_cssclass("btn_WF_basic00");
            obj.set_font("bold 15px/normal \"NanumGothic\"");
            this.divMsg.addChild(obj.name, obj);
            ...
            obj = new Button("btnCancle","0",null,"180","50",null,"0",null,null,null,null,this.divMsg.form);
            obj.set_taborder("2");
            obj.set_text("취소");
            ...
            obj = new Button("btnClose",null,"0","49","49","0",null,null,null,null,null,this.divMsg.form);
            obj.set_taborder("1");
            obj.set_visible("false");
            obj.set_borderRadius("0px");
            obj.set_background("url(\'theme://images/img_POP_close.png\') no-repeat center center transparent");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",360,300,this,function(p){});
