(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("comGridHide.xfdl", function() {
        /***************************************************************************************************
         * 업무구분		: UXBooster
         * 화 면 명		: comHide.xfdl
        	...
        	if (take.formOnLoad(this)) //공통 온로드(필수) : 최초 온로드시 공통으로 호출되는 함수 --> 필수
        	{
        		...
        		if (this.fvGrd._xfnIsArray(this.fvGrd["_hideInfo"]))
        		{
        			...
        			for (var i=0; i<arrHideInfo.length; i++)
        			{
        				...
        				var nOrgSize 	= arrHideInfo[i].size;
        ...
        this.loadIncludeScript("comGridHide.xfdl");
