(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"PROGRAM_ID\" type=\"STRING\" size=\"256\"/><Column id=\"IMAGE_URI\" type=\"BLOB\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divForm","460","30",null,"500","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("5");
            this.divDetail.addChild(obj.name, obj);
            ...
            obj = new Button("btnCapture",null,"3","80","23","135",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("6");
            obj.set_text("화면캡쳐");
            obj.set_cssclass("btn_WF_basic01");
            this.divDetail.addChild(obj.name, obj);
            ...
            obj = new Layout("default","",0,0,this.divDetail.form,
                ...
                p.divForm.move("460","30",null,"500","0",null);

                p.btnCapture.set_taborder("6");
                p.btnCapture.set_text("화면캡쳐");
                p.btnCapture.set_cssclass("btn_WF_basic01");
                p.btnCapture.move(null,"3","80","23","135",null);
            	}
            );
        ...
        // User Script
        this.registerScript("modFormDesign_test.xfdl", function() {
        /**
        *  SYSTEM FORM NAME
        *
        *  @MenuPath    PM > PM040
        ...
        ********************************************************/
        ...
        this.divDetail_btnFormDesign_onclick = function(obj,e)
        {
            ...
            sPrefix = objDs.getColumn(nRow, "PREFIX");
        ...
        this.divDetail_btnCapture_onclick = function(obj,e)
        {
            ...
            this.dsFormList.set_rowposition(-1);
            this.fv_bStart = true;
            this.dsFormList.set_rowposition(0);
        };
        ...
        ********************************************************/
        ...
        this.fnCaptueForm = function()
        {
            ...
            take.formCapture(this.divDetail.form.divForm.form.divForm, objDs, "IMAGE_URI", objDs.rowposition);
        }
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divDetail.form.grdForm.addEventHandler("oncellclick",this.divDetail_grdForm_oncellclick,this);
            this.divDetail.form.btnFormDesign.addEventHandler("onclick",this.divDetail_btnFormDesign_onclick,this);
            this.divDetail.form.btnCapture.addEventHandler("onclick",this.divDetail_btnCapture_onclick,this);
        ...
        this.loadIncludeScript("modFormDesign_test.xfdl");
