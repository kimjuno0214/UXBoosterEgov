(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staRegUserT","edtTitle:50","10","80","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("작성자");
            obj.set_cssclass("sta_WF_textR");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtRegUser","staRegUserT:10","10","195","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staTermT","edtRegUser:50","10","80","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("작성일");
            obj.set_cssclass("sta_WF_textR");
            this.divSearch.addChild(obj.name, obj);
        ...
        ********************************************************/
        ...
        this.fnSearch = function(sTranId)
        {
        	...
        	var sCalFrom = this.divSearch.form.calFrom.value;
        	var sCalTo	 = this.divSearch.form.calTo.value;
