(function()
{
    return function()
    {
        ...
        {
            this.set_name("CM010P02");
            this.set_titletext("공지사항상세조회");
            this.set_background("#ffffff");
            if (Form == this.constructor)
            {
                this._setFormPosition(850,610);
            }
            ...
            obj._setContents("<ColumnInfo><Column id=\"FILE_PATH\" type=\"STRING\" size=\"256\"/><Column id=\"PROJECT_CD\" type=\"STRING\" size=\"256\"/><Column id=\"MENU_CD\" type=\"STRING\" size=\"256\"/><Column id=\"FILE_NM\" type=\"STRING\" size=\"256\"/><Column id=\"FILE_SAVE_NM\" type=\"STRING\" size=\"256\"/><Column id=\"IMPORT_YN\" type=\"STRING\" size=\"256\"/><Column id=\"FILE_TYPE\" type=\"STRING\" size=\"256\"/><Column id=\"FILE_SIZE\" type=\"STRING\" size=\"256\"/><Column id=\"FILE_BLOB\" type=\"STRING\" size=\"256\"/><Column id=\"DESC_TXT\" type=\"STRING\" size=\"256\"/><Column id=\"DELETE_YN\" type=\"STRING\" size=\"256\"/><Column id=\"USER_CD\" type=\"STRING\" size=\"256\"/><Column id=\"FILE_DEL_YN\" type=\"STRING\" size=\"256\"/><Column id=\"ATTACH_CD\" type=\"STRING\" size=\"256\"/><Column id=\"FILE_SEQ\" type=\"STRING\" size=\"256\"/><Column id=\"CHK\" type=\"STRING\" size=\"256\"/><Column id=\"REG_DT\" type=\"STRING\" size=\"256\"/><Column id=\"REG_NM\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static01","20","50",null,"31","20",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_cssclass("sta_WF_th01L");
            this.addChild(obj.name, obj);

            obj = new Edit("edtTitle","27","55",null,"21","30",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_readonly("true");
            this.addChild(obj.name, obj);

            obj = new Static("Static02","20","80",null,null,"20","133",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_cssclass("sta_WF_th01L");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static03","20","477",null,"10","20",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("10");
            obj.set_background("red");
            obj.set_visible("false");
            ...
            obj = new Div("divFile","20",null,null,"60","20","63",null,null,null,null,this);
            obj.set_taborder("7");
            ...
            obj = new Button("btnAllDown",null,"15","70","25","10",null,null,null,null,null,this.divFile.form);
            obj.set_taborder("0");
            obj.set_text("일괄다운");
            obj.set_visible("true");
            this.divFile.addChild(obj.name, obj);

            obj = new WebBrowser("wbWebEditor","27","91",null,null,"31","143",null,null,null,null,this);
            obj.set_taborder("8");
            this.addChild(obj.name, obj);

            obj = new Button("btnDelete",null,"20","46","25","20",null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("삭제");
            obj.set_visible("false");
            ...
            obj = new Button("btnModify",null,"20","46","25","btnDelete:3",null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("수정");
            ...
            obj = new Button("btnClose",null,"567","58","23","20",null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("닫기");
            obj.set_cssclass("btn_WF_cancel01");
            this.addChild(obj.name, obj);

            obj = new Static("Static04_00_00","20","547",null,"20","20",null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("20");
            obj.set_background("red");
            obj.set_visible("false");
            ...
            obj = new Static("Static04_00","20","590",null,"20","20",null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("20");
            obj.set_background("red");
            obj.set_visible("false");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",850,610,this,function(p){});
        ...
        // User Script
        this.registerScript("CM010P02.xfdl", function() {
        /**
        *  SYSTEM FORM NAME
        *
        ...
        */
        this.CM010P02_onload = function(obj, e)
        {
        ...
        ********************************************************/
        ...
        this.CM010P02_ontimer = function(obj,e)
        {
        	if (e.timerid==1)
        	{
        ...
        */
        ...
        {
            this.addEventHandler("onload",this.CM010P02_onload,this);
            this.addEventHandler("ontimer",this.CM010P02_ontimer,this);
        ...
        this.loadIncludeScript("CM010P02.xfdl");
