(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divDetail","0","btnShowHide:20",null,null,"0","0","1300",null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"100\"/><Column size=\"244\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"No.\"/><Cell col=\"1\" text=\"권한코드\" autosizecol=\"default\"/><Cell col=\"2\" text=\"권한명\" displaytype=\"normal\" autosizecol=\"default\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:ROLE_CD\" autosizecol=\"default\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:ROLE_NM\" displaytype=\"text\" autosizecol=\"default\" editmaxlength=\"10\"/></Band></Format></Formats>");
            ...
            obj = new Static("staRoleListT","10","0","440","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("2");
            obj.set_text("권한 목록");
            obj.set_cssclass("sta_WF_title02");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staRoleMapT","470","0",null,"21","90",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("3");
            obj.set_text("대시보드 목록");
            obj.set_cssclass("sta_WF_title02");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("Static45","450","0","20",null,null,"0",null,null,null,null,this.divDetail.form);
            obj.set_taborder("4");
