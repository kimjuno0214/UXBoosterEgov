(function()
{
    return function()
    {
        ...
        {
            this.set_name("smpForm04_01");
            this.set_titletext("Sample04_01 - CRUD");
        ...
        // User Script
        this.registerScript("smpForm04_01.xfdl", function() {
        /**
        *  SYSTEM FORM NAME
        *
        *  @MenuPath    1Depth > 2Depth
        *  @FileName    smpForm04_01.xfdl
        *  @Creator     김대승
        ...
        ********************************************************/
        ...
        this.fnSearch = function(sTranId)
        {
            ...
            if (take.nvl(sTranId, "")=="") sTranId = "UserListSelect";
        	...
        	switch(sTranId) {
                ...
                case "userSelect":
        			...
        			if (take.nvl(objDsUserList.userrow,"")!="")
        			{
        				objDsUserList.set_rowposition(objDsUserList.userrow);
        				objDsUserList.userrow = "";
        			}
        ...
        this.fnSave = function(sTranId)
        {
        	...
        	var objDs;
        	var nRow;
        	objDs = this.dsUserList;
        	nRow  = parseInt(this.dsList.rowcount-1);
        	if(this.dsList.getRowType(nRow)==2){
        		objDs.userrow = objDs.rowcount;
        	} else {
        		objDs.userrow = objDs.rowposition;
        	}
        	...
        	{
        // 		if(take.isDsModified(this.dsUserList)){
        // 			take.tranSave(this, sTranId, "Sample.smpForm04", "dsUserList", "", "", "fnCallBack");
        // 		}
        		//take.tranSave(this, sTranId, "Sample.smpForm04", "dsList", "", "", "fnCallBack");
                take.transaction(this, sTranId, "SVC_LOC::sample/smpForm04Save.do", "dsUserList=dsUserList:U dsList=dsList:U", "", "", "fnCallBack");
        	}
        }
        ...
        this.fnDelRow = function(sGrdId, arrnRow)
        {
        	...
        	if (take.confirm(this, "Info", "삭제 하시겠습니까?"))
        	{
        		...
        		//take.tranSave(this, "userDelete", "Sample.smpForm04", "dsUserList", "", "", "fnCallBack");
        	}
        }
        ...
        */
        ...
        this.loadIncludeScript("smpForm04_01.xfdl");
