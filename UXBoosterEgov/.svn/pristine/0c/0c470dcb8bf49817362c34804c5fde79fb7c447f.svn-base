(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divSearch","10","0",null,"43","10",null,"831",null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Div("divDetail","0","73",null,null,"0","0","831",null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Grid("grdRoleList","10","26","440",null,null,"10",null,null,null,null,this.divDetail.form);
            obj.set_taborder("0");
            ...
            obj = new Grid("grdRoleMenu","470","26",null,null,"10","10",null,null,null,null,this.divDetail.form);
            obj.set_taborder("1");
            ...
            obj = new Static("staRoleListT","10","0","450","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("2");
            obj.set_text("권한 목록");
            obj.set_cssclass("sta_WF_title02");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staRoleMapT","470","0",null,"21","100",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("3");
            obj.set_text("권한 매핑");
            obj.set_cssclass("sta_WF_title02");
            this.divDetail.addChild(obj.name, obj);

            obj = new Button("btnRoleSave",null,"0","46","21","10",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("4");
            obj.set_text("저장");
            obj.set_cssclass("btn_WF_save02");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("Static01","450","26","20",null,null,"0",null,null,null,null,this.divDetail.form);
            obj.set_taborder("5");
            obj.set_text("20");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
            ...
            obj = new Layout("default","",0,0,this.divDetail.form,
                ...
                p.grdRoleList.move("10","26","440",null,null,"10");
            ...
            obj = new Layout("default0","",0,0,this.divDetail.form,
                ...
                p.staRoleListT.set_taborder("0");
                p.staRoleListT.set_text("권한 목록");
                p.staRoleListT.set_cssclass("sta_WF_title02");
                p.staRoleListT.move("0","0","450","30",null,null);

                p.grdRoleList.set_taborder("1");
                p.grdRoleList.set_binddataset("dsProjectRoleList");
            ...
            obj = new Layout("default","",1659,832,this,
                ...
                p.divDetail.set_minwidth("831");
                p.divDetail.set_maxwidth("");
                p.divDetail.move("0","73",null,null,"0","0");
        ...
        // User Script
        this.registerScript("PM040_bak.xfdl", function() {
        /**
        *  SYSTEM FORM NAME
        *
        *  @MenuPath    PM > PM040
        ...
        */
        ...
        this.divSearch_Static07_onclick = function(obj,e)
        {
        ...
        this.loadIncludeScript("PM040_bak.xfdl");
