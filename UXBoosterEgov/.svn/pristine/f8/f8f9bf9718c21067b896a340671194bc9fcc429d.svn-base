(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staLoginInfoSearch","690","39","80","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("접속기기/환경");
            obj.set_cssclass("sta_WF_textR");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staUserInfoSearch","19","39","80","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("사용자");
            obj.set_cssclass("sta_WF_textR");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("staMlGroupSearch00","355","10","80","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("이력일시");
            obj.set_cssclass("sta_WF_textR");
            this.divSearch.addChild(obj.name, obj);

            obj = new Calendar("calLoginDateFromSearch","staMlGroupSearch00:10","10","90","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            ...
            obj = new Static("Static14","calLoginDateFromSearch:0","10","15","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("19");
            obj.set_text("~");
            ...
            obj = new Calendar("calLoginDateToSearch","Static14:0","10","90","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_dateformat("yyyy-MM-dd HH:mm:ss");
            obj.set_editformat("yyyy-MM-dd HH:mm:ss");
            obj.set_cssclass("cal_WF_essential");
            ...
            obj = new Edit("edtUserInfoSearch","staUserInfoSearch:10","39","196","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staProgramInfoSearch","355","39","80","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("메뉴");
            obj.set_cssclass("sta_WF_textR");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj = new Edit("edtLoginInfoSearch","staLoginInfoSearch:10","39","196","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("12");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("staHistoryTypeSearch","690","10","80","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("이력유형");
            obj.set_cssclass("sta_WF_textR");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboHistoryTypeSearch","staHistoryTypeSearch:10","10","195","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            ...
            obj = new Div("divDetail","10","102",null,null,"10","10","1020",null,null,null,this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);
