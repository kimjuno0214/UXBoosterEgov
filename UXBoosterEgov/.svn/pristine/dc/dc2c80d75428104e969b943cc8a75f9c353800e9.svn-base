(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnSearch","120","65","256","137",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Button00");
            this.addChild(obj.name, obj);

            obj = new Button("btn00","472","57","185","144",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("btn00");
            this.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("dgdsg.xfdl", function() {
        /**
        *  SYSTEM FORM NAME
        *
        ...
        */
        ...
        {
            this.addEventHandler("onload",this.dgdsg_onload,this);
            this.btnSearch.addEventHandler("onclick",this.btnSearch_onclick,this);
            this.btn00.addEventHandler("onclick",this.btn00_onclick,this);
        };
        this.loadIncludeScript("dgdsg.xfdl");
