(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new ImageViewer("imgView","5","edtFile:3","696","330",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("미리보기");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("smpNewFile.xfdl", function() {
        //멀티 파일 선택
        ...
        this.loadIncludeScript("smpNewFile.xfdl");
