(function()
{
    return function()
    {
        ...
        {
            this.set_name("Guide010");
            this.set_titletext("Guide010");
            ...
            obj = new Grid("Grid00","-1","26","48.69%",null,null,"0",null,null,null,null,this.divDetail.form);
            obj.set_taborder("2");
            ...
            obj = new Static("Static02","Grid00:20","0",null,"21","20",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("1");
            obj.set_text("Test");
            obj.set_cssclass("sta_WF_title02");
            this.divDetail.addChild(obj.name, obj);

            obj = new Button("Button04","Grid00:5","344","10","30",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("3");
            obj.set_cssclass("btn_WF_next");
            this.divDetail.addChild(obj.name, obj);

            obj = new Button("Button05","Grid00:5","384","10","30",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("4");
            obj.set_cssclass("btn_WF_prev");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("Static00","812","67","5","300",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("5");
            obj.set_text("5");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
            ...
            obj = new Static("Static03","797","67","5","300",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("6");
            obj.set_text("5");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
            ...
            obj = new Grid("Grid01","Grid00:20","26",null,null,"0","0",null,null,null,null,this.divDetail.form);
            obj.set_taborder("7");
            obj.set_binddataset("Dataset00");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"59\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"Column0\"/><Cell col=\"1\" text=\"Column1\"/><Cell col=\"2\" text=\"Column2\"/><Cell col=\"3\" text=\"Column3\"/><Cell col=\"4\" text=\"Column4\"/><Cell col=\"5\" text=\"Column5\"/></Band><Band id=\"body\"><Cell text=\"bind:Column0\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"bind:Column1\"/><Cell col=\"2\" text=\"bind:Column2\"/><Cell col=\"3\" text=\"bind:Column3\"/><Cell col=\"4\" text=\"bind:Column4\"/><Cell col=\"5\" text=\"bind:Column5\"/></Band></Format></Formats>");
        ...
        this.loadIncludeScript("Guide010.xfdl");
