(function()
{
    return function()
    {
        ...
        {
            this.set_name("sampleGridPaging");
            this.set_titletext("(샘플)그리드페이징필터");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"100\"/><Column size=\"300\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"COL0\"/><Cell col=\"1\" text=\"COL1\"/></Band><Band id=\"body\"><Cell text=\"bind:COL0\"/><Cell col=\"1\" text=\"bind:COL1\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("btn_execute","427","40","90","21",null,null,null,null,null,null,this);
            obj.set_taborder("1");
        ...
        // User Script
        this.registerScript("sampleGridPaging.xfdl", function() {
        /*
        ...
        this.loadIncludeScript("sampleGridPaging.xfdl");
