(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staName","10","10","80","21",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("사원명");
            obj.set_cssclass("sta_WF_textR");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtName","staName:10","10",null,"21","10",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            ...
            obj = new Div("divDetail","20","btnShowHide:0",null,null,"20","63",null,null,null,null,this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnEnter",null,null,"57","23","btnCancle:5","20",null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("확인");
            ...
            obj = new Static("Static01_00","20","divDetail:0",null,"20","20",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("H20");
            obj.set_background("#fd9da0");
            obj.set_opacity("0.5");
        ...
        ********************************************************/
        ...
        {
        	var sRtn = this.dsApprover.getColumn(this.dsApprover.rowposition, "USER_CD") +','+ this.dsApprover.getColumn(this.dsApprover.rowposition, "USER_NM");
        ...
        ********************************************************/
        ...
        this.fnInit = function()
        {
            ...
            {
                case "HR010" :  // 개인휴가관리
                    this.set_titletext(this.parent.sTitle);
        			//objDivSearch.staCode.set_text("승인자코드");
                    objDivSearch.staName.set_text("승인자명");

                    // 2020.01.20 추가 김태규수석님 고정
                    //objDivSearch.edtCode.set_value("U000000020");
        ...
        */
        this.fnCallback = function(sId, nErrCd, sErrMsg)
        {
            ...
            switch(sId)
            {
        		...
        		case "userList" :  //저장 콜백
                    this.divDetail.form.staTitle.set_text("사원 검색 목록 (" + this.dsApprover.rowcount + "건)");
                    break;
        		case "Save" :  //저장 콜백
        ...
        this.on_initEvent = function()
        {
            ...
            this.divDetail.form.grdList.addEventHandler("oncelldblclick",this.grdList_oncelldblclick,this);
