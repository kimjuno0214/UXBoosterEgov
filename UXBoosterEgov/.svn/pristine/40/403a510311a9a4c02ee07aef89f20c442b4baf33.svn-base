(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staProgCd","449","26",null,"31","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("9");
            obj.set_cssclass("sta_WF_td01L");
            this.divDetail.addChild(obj.name, obj);
            ...
            obj = new Edit("edtProgId","457","61","233","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("3");
            ...
            obj = new Static("staUseYnT","697","116","120","31",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("19");
            obj.set_text("사용여부");
            obj.set_cssclass("sta_WF_th01L");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staProgTypeT","697","86","120","31",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("26");
            obj.set_text("프로그램 유형");
            obj.set_cssclass("sta_WF_th01L");
            this.divDetail.addChild(obj.name, obj);

            obj = new Edit("edtProgNm","457","91","233","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("4");
            obj.set_cssclass("edt_WF_essential");
            this.divDetail.addChild(obj.name, obj);

            obj = new Combo("cboPrefix","457","121","233","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("5");
            ...
            obj = new Combo("cboUseYn","824","121","233","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("7");
            ...
            obj = new Combo("cboProgType","824","91","233","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("6");
            ...
            obj = new Static("staRegDtT","697","282","120","31",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("21");
            obj.set_text("등록일");
            obj.set_cssclass("sta_WF_th01L");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staModDtT","697","312","120","31",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("24");
            obj.set_text("수정일");
            obj.set_cssclass("sta_WF_th01L");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staRegNm","459","287","210","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("28");
            obj.set_text("");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staRegNm00","459","317","210","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("29");
            obj.set_text("");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staRegDt","826","287","210","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("30");
            obj.set_text("");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staModDt","826","317","210","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("31");
            this.divDetail.addChild(obj.name, obj);
