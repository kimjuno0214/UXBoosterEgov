(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divDetail","20","btnShowHide:20",null,null,"20","64",null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static01_01","0",null,null,"20","0","44",null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("H20");
            obj.set_background("#fd9da0");
            obj.set_opacity("0.5");
        ...
        */
        ...
        {
        	this.ProgId="GM00000114";
            this.ProgNm="GM00000114";
        ...
        ********************************************************/
        ...
        this.fnCheckForm = function()
        {
            ...
            if(sName == ""){
                //alert("사용자명을 작성해주세요.");
        		take.alert(this, "Info", "MS00000014", {text:this.divSearch.form.staName.text});
                return false;
            }
            return true;
        }
        ...
        this.fnSendData = function()
        {
        	...
        	if (this.opener.name == "PM050"){
        		var nRow   		= objDsApprover.rowposition;		// USER_INFO TABLE
