(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnShowHide","42.11%","88","60","10",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Div("divDetail","20","118",null,null,"20","63",null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("Div00");
            this.addChild(obj.name, obj);
        ...
        */
        ...
        {
        	this.ProgId="PM010P02";
            this.ProgNm="PM010P02";
