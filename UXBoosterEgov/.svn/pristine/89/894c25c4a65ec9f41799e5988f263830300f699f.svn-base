(function()
{
    return function()
    {
        ...
        {
            this.set_name("Guide003");
            this.set_titletext("Guide003");
            ...
            obj = new Static("Static29","0","0","530","21",null,null,null,null,null,null,this.divDetail.form.divSub2.form);
            obj.set_taborder("1");
            ...
            obj = new Static("Static18","0",null,null,"10","20","0",null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("10");
            obj.set_background("rgba(255,0,0,0.4)");
            obj.set_visible("false");
        ...
        this.loadIncludeScript("Guide003.xfdl");
