(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static01_01","0","divDetail:0",null,"20","0",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("H20");
            obj.set_background("#fd9da0");
            obj.set_opacity("0.5");
            ...
            this.divDetail.form.addLayout(obj.name, obj);
            //-- Default Layout : this
            obj = new Layout("default","",480,500,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                p = rootobj;
                p.set_titletext("프로젝트관리_메뉴관리_프로그램선택팝업");
                ...
                p.divDetail.set_taborder("8");
                p.divDetail.set_text("");
                p.divDetail.move("20","btnShowHide:20",null,null,"20","63");

                p.btnProgramSearch.set_taborder("2");
                ...
                p.Static02_00_00.set_taborder("3");
                p.Static02_00_00.set_text("W\r\n20");
                p.Static02_00_00.set_background("#fd9da0");
                p.Static02_00_00.set_opacity("0.5");
                p.Static02_00_00.set_textAlign("center");
                p.Static02_00_00.set_visible("false");
                p.Static02_00_00.move(null,"0","20",null,"0","0");
                ...
                p.Static02_00.set_text("W\r\n20");
                p.Static02_00.set_background("#fd9da0");
                p.Static02_00.set_opacity("0.5");
                p.Static02_00.set_textAlign("center");
                p.Static02_00.set_visible("false");
                p.Static02_00.move("0","0","20",null,null,"0");

                p.Static01_01.set_taborder("6");
                ...
                p.Static01_01.move("0","divDetail:0",null,"20","0",null);
                ...
                p.btnSend.set_taborder("9");
                p.btnSend.set_cssclass("btn_WF_check01");
                p.btnSend.set_text("확인");
                p.btnSend.move(null,"divDetail:20","57","23","80",null);
                ...
                p.Static01_00_00.set_taborder("11");
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.btnSend.addEventHandler("onclick",this.btnEnter_onclick,this);
