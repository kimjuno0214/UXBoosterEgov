(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("Edit00","136","15",null,"21","16",null,null,null,null,null,this);
            obj.set_taborder("4");
            this.addChild(obj.name, obj);

            obj = new Edit("Edit01","136","45",null,"21","16",null,null,null,null,null,this);
            obj.set_taborder("5");
            this.addChild(obj.name, obj);

            obj = new Button("Button01",null,"111","46","23","544",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("변경");
            ...
            obj = new Edit("Edit02","136","75",null,"21","16",null,null,null,null,null,this);
            obj.set_taborder("8");
            this.addChild(obj.name, obj);

            obj = new Button("Button00",null,"111","46","23","491",null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("취소");
            obj.set_cssclass("btn_WF_basic01");
            this.addChild(obj.name, obj);
        ...
        this.loadIncludeScript("publishing033.xfdl");
