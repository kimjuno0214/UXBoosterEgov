(function()
{
    return function()
    {
        ...
        {
            this.set_name("SM030P03");
            this.set_titletext("주관식 및 기타의견 팝업");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"300\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell displaytype=\"normal\" edittype=\"normal\" text=\"답변\"/></Band><Band id=\"body\"><Cell edittype=\"none\" displaytype=\"normal\" text=\"bind:ITEM_RESULT\"/></Band></Format></Formats>");
        ...
        // User Script
        this.registerScript("SM030P03.xfdl", function() {
        /**
        *  SYSTEM FORM NAME
        *
        ...
        */
        ...
        this.fv_sPopGbn = take.nvl(this.parent.sPopGbn, "");
        ...
        ****************************************************************************************/
        ...
        this.fnSearch = function(sTranId)
        {
        	...
        	var sParam = "";
        	var sNamespace = ( "01" == this.fv_sPopGbn ) ? "SurveyManagementMapper.surveyAnswerResultList" : "SurveyManagementMapper.surveyEtcResultList";
        	var sFormTitle = ( "01" == this.fv_sPopGbn ) ? "주관식 답변보기" : "기타의견 보기";

        	this.set_titletext(sFormTitle);
        ...
        */
        ...
        this.loadIncludeScript("SM030P03.xfdl");
