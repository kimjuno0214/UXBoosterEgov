(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnShowHide","46.25%","43","60","10",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_cssclass("btn_WF_fold01");
            this.addChild(obj.name, obj);

            obj = new Static("Static24","0","53",null,"20","10",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("20");
            ...
            obj = new Layout("default","",800,600,this,
                ...
                p.btnShowHide.move("46.25%","43","60","10",null,null);

                p.Static24.set_taborder("2");
                ...
                p.Static24.move("0","53",null,"20","10",null);

                p.divDetail.set_taborder("3");
                p.divDetail.move("10","73",null,null,"10","10");
            	}
            );
            this.addLayout(obj.name, obj);

            //-- Normal Layout : this
            obj = new Layout("Layout0","",340,400,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
        ...
        // User Script
        this.registerScript("edu.xfdl", function() {
        /**
        *  SYSTEM FORM NAME
        *
        ...
        */
        ...
        this.loadIncludeScript("edu.xfdl");
