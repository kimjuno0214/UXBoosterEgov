(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("BM010P01.xfdl", function() {
        /**
        *  SYSTEM FORM NAME
        *
        ...
        */
        this.BM010P01_onload = function(obj, e)
        {
            this.fnInit();
        }
        ...
        */
        ...
        {
            this.addEventHandler("onload",this.BM010P01_onload,this);
        ...
        this.loadIncludeScript("BM010P01.xfdl");
