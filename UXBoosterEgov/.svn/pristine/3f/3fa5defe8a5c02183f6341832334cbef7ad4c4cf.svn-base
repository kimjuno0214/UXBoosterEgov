(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Combo("cboUseYn","staUseYnT:7","91","230","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("5");
            ...
            obj = new Edit("edtTemplateNm","staTemplateNmT:7","61","230","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("4");
            ...
            obj = new Static("Static06","449","Static04:-1",null,null,"0","0",null,null,null,null,this.divDetail.form);
            obj.set_taborder("17");
            obj.set_cssclass("sta_WF_td01L");
            obj.set_text("");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staModDtT","666",null,"120","31",null,"0",null,null,null,null,this.divDetail.form);
            obj.set_taborder("18");
            obj.set_text("수정일");
            obj.set_cssclass("sta_WF_th01L");
            this.divDetail.addChild(obj.name, obj);
            ...
            obj = new Static("staRegNm","staRegNmT:9","wbWebEditor:9","150","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("21");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staModNm","staModNmT:9","staRegNm:9","150","21",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("22");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("staRegDtT00","666",null,"120","31",null,"30",null,null,null,null,this.divDetail.form);
            obj.set_taborder("25");
            obj.set_text("등록일");
            obj.set_cssclass("sta_WF_th01L");
            this.divDetail.addChild(obj.name, obj);
