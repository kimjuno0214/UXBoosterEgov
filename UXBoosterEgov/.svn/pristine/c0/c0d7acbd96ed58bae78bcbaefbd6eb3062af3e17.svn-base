(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("2");
            obj.set_text("그리드 공통 기능 : 스크롤 페이징");
            ...
            obj.set_taborder("3");
            obj.set_text("\'takegrid\' User Property 추가 후 사용할 그리드 기능 세팅\r\n\r\n스크롤 페이징 기능 사용시 \'searchfunction\' User Property 추가 후 조회 함수 세팅 ");
        ...
        // User Script
        this.registerScript("smpTakeGridNewScrollPaggingOption.xfdl", function() {
        this.fv_sGridFormat = "";
        ...
        this.loadIncludeScript("smpTakeGridNewScrollPaggingOption.xfdl");
