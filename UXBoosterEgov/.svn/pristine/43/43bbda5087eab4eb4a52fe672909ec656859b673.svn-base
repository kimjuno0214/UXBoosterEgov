(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new BindItem("item1","divSearch.form.edtUserId","value","dsSearch","USER_CD");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item0","divSearch.form.edtUserPw","value","dsSearch","USER_NM");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        */
        this.fnCallback = function(sId, nErrCd, sErrMsg)
        {
            ...
            switch(sId)
            {
                case "Save" :  //저장 콜백
        			...
        			take.alert(this, "Info", "MS00000002", {text:this.divSearch.form.staUserId.text});
        			this.close();
                    break;
                default :
                    break;
        ...
        this.divSearch_btnCreate_onclick = function(obj,e)
        {
        	...
        	if( sUserId == "" )		take.alert(this, "Info", "MS00000014", {text:this.divSearch.form.staUserId.text});//alert("사용자ID를 입력해 주세요.");
        	if( sUserNm == "" )		take.alert(this, "Info", "MS00000014", {text:this.divSearch.form.staUserNm.text});//alert("사용자명을 입력해 주세요.");
        	if( sUserPw == "" )		take.alert(this, "Info", "MS00000014", {text:this.divSearch.form.staUserPwOk.text});//alert("비밀번호를 입력해 주세요.");
        	if( sValidDtFr == "" )	take.alert(this, "Info", "MS00000014", {text:this.divSearch.form.staValidDt.text});//alert("유효기간 시작일을 입력해 주세요.");
        	if( sValidDtTo == "" )	take.alert(this, "Info", "MS00000014", {text:this.divSearch.form.staValidDt.text});//alert("유효기간 종료일을 입력해 주세요.");
