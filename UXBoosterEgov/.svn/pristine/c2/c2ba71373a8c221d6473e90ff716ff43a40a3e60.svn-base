(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("dbcDocument.xfdl", function() {
        this.fv_sTitle = null;
        this.fv_objGdsUserInfo = nexacro.getApplication().gdsUserInfo;
        this.fv_sProjectCd = nexacro.getApplication().av_sProjectCd;
        this.fv_sMenuCd = "M0028";

        this.dbcDocument_onload = function(obj,e)
        {
        ...
        this.divMain_grdNotice01_oncellclick = function(obj,e)
        {
        ...
        {
            this.addEventHandler("onload",this.dbcDocument_onload,this);
            this.divMain.form.grdNotice01.addEventHandler("oncellclick",this.divMain_grdNotice01_oncellclick,this);
        };
        this.loadIncludeScript("dbcDocument.xfdl");
