(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("edtLayout","108","76","347","23",null,null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("22");
            obj.set_password("false");
            obj.set_text("TEXT");
            this.divDetail.addChild(obj.name, obj);
            ...
            obj = new Grid("grdSub00","0","staLable04:11",null,"150","0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("12");
            ...
            obj = new Grid("grdSub01","0","staViewLayout:10",null,null,"0","0",null,null,null,null,this.divDetail.form);
            obj.set_taborder("15");
            obj.set_binddataset("dsViewLayout");
            obj.set_autofittype("none");
            obj.set_autoenter("select");
            obj.set_visible("true");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"150\"/><Column size=\"150\"/><Column size=\"70\"/><Column size=\"100\"/><Column size=\"150\"/><Column size=\"60\"/><Column size=\"80\"/><Column size=\"150\"/><Column size=\"70\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"Col ID\"/><Cell col=\"1\" text=\"Col Name\"/><Cell col=\"2\" text=\"Display Y/N\"/><Cell col=\"3\" text=\"Display Order\"/><Cell col=\"4\" text=\"Display Type\"/><Cell col=\"5\" text=\"Size\"/><Cell col=\"6\" text=\"Align\"/><Cell col=\"7\" text=\"Edit Type\"/><Cell col=\"8\" text=\"필수입력 Y/N\"/><Cell col=\"9\" text=\"Bind Dataset\"/><Cell col=\"10\" text=\"ETC1\"/><Cell col=\"11\" text=\"ETC2\"/><Cell col=\"12\" text=\"ETC3\"/></Band><Band id=\"body\"><Cell displaytype=\"text\" edittype=\"text\" textAlign=\"left\" text=\"bind:COL_ID\"/><Cell col=\"1\" displaytype=\"text\" edittype=\"text\" textAlign=\"left\" text=\"bind:COL_NAME\"/><Cell col=\"2\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\" combodataset=\"dsCboYn\" combocodecol=\"CODE\" combodatacol=\"NAME\" textAlign=\"center\" text=\"bind:DISPLAY_YN\"/><Cell col=\"3\" displaytype=\"text\" edittype=\"text\" textAlign=\"center\" text=\"bind:DISPLAY_ORDER\"/><Cell col=\"4\" displaytype=\"combocontrol\" edittype=\"combo\" textAlign=\"center\" text=\"bind:DISPLAY_TYPE\" combodataset=\"dsDisplayType\" combocodecol=\"CODE\" combodatacol=\"NAME\"/><Cell col=\"5\" displaytype=\"text\" edittype=\"text\" textAlign=\"center\" text=\"bind:SIZE\"/><Cell col=\"6\" displaytype=\"combocontrol\" edittype=\"combo\" text=\"bind:ALIGN\" combodataset=\"dsCboAlign\" combocodecol=\"CODE\" combodatacol=\"NAME\"/><Cell col=\"7\" displaytype=\"combocontrol\" edittype=\"combo\" textAlign=\"center\" text=\"bind:EDIT_TYPE\" combodataset=\"dsEditType\" combocodecol=\"CODE\" combodatacol=\"NAME\"/><Cell col=\"8\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\" combodataset=\"dsCboYn\" combocodecol=\"CODE\" combodatacol=\"NAME\" textAlign=\"center\" text=\"bind:INPUT_YN\"/><Cell col=\"9\" displaytype=\"combocontrol\" edittype=\"combo\" textAlign=\"center\" text=\"bind:BIND_DATASET\" combodataset=\"dsDataset\" combocodecol=\"DATASET_NAME\" combodatacol=\"DATASET_NAME\"/><Cell col=\"10\" displaytype=\"text\" edittype=\"text\" textAlign=\"center\" text=\"bind:ETC1\"/><Cell col=\"11\" displaytype=\"text\" edittype=\"text\" textAlign=\"center\" text=\"bind:ETC2\"/><Cell col=\"12\" displaytype=\"text\" edittype=\"text\" textAlign=\"center\" text=\"bind:ETC3\"/></Band></Format></Formats>");
            this.divDetail.addChild(obj.name, obj);
            ...
            obj = new Combo("cboViewDataset1",null,"grdSub00:15","111","24","78",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("20");
            obj.set_innerdataset("dsDataset");
            obj.set_codecolumn("QUERY_ID");
            obj.set_datacolumn("DATASET_NAME");
            obj.set_text("Combo00");
            this.divDetail.addChild(obj.name, obj);

            obj = new Button("btnLoad",null,"464","60","25","10",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("24");
            obj.set_text("Load");
            obj.set_cssclass("btn_cm_basic01");
            this.divDetail.addChild(obj.name, obj);

            obj = new Static("Static00",null,"465","80","22","cboViewDataset1:0",null,null,null,null,null,this.divDetail.form);
            obj.set_taborder("25");
            obj.set_text("Dataset 선택: ");
            this.divDetail.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("srcMaker.xfdl", function() {
        /**
        *  SYSTEM FORM NAME
        *
           ...
           if (take.formOnLoad(this)) //공통 온로드(필수) : 최초 온로드시 공통으로 호출되는 함수 --> 필수
           {
        		...
        		take.transaction(this, "Init", "SVC_LOC::srcmaker/init.do", "", "dsInitInfo=dsInitInfo", ""
        			...
        			trace(this.dsInitInfo.saveXML());
        				...
        				this.divDetail.form.edtLayout.set_value("일반 그리드");
        ...
        this.fnTran = function(sTranId)
        {
            ...
            switch(sTranId)
            {
        		...
        		case "SourceMaker" :  // Query Load
                    take.transaction(this, sTranId, "SVC_LOC::srcmaker/save.do", "dsBaseInfo=dsBaseInfo dsDataset=dsDataset dsSearchLayout=dsSearchLayout dsViewLayout1=dsViewLayout", "", "", sCallBack);
                    break;
                default :
                    break;
            }
        ...
        */
        this.btnSave_onclick = function(obj,e)
        {
        	...
        	objDs.setColumn(nRow, "MAKER_TYPE", "OLD");
        ...
        ********************************************************/
        ...
        this.on_initEvent = function()
        {
            ...
            this.divDetail.form.grdSub01.addEventHandler("onheadclick",this.grid_onheadclick,this);
            this.divDetail.form.btnLoad.addEventHandler("onclick",this.divDetail_btnLoad_onclick,this);
        ...
        this.loadIncludeScript("srcMaker.xfdl");
