(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"CODE\" type=\"STRING\" size=\"256\"/><Column id=\"NAME\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"CODE\">1</Col><Col id=\"NAME\">오름차순</Col></Row><Row><Col id=\"CODE\">0</Col><Col id=\"NAME\">내림차순</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("comGridSort.xfdl", function() {
        /***************************************************************************************************
         * 업무구분		: UXBooster
         * 화 면 명		: comSort.xfdl
         * 화면설명		: 그리드 공통 정렬 팝업
        ...
        this.loadIncludeScript("comGridSort.xfdl");
